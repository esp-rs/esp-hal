...
fn main() {
    ...
    println!("cargo::rustc-env=ESP_BOOTLOADER_SUPPORT_BUILD_TIME={build_time_formatted}");
    println!("cargo::rustc-env=ESP_BOOTLOADER_SUPPORT_BUILD_DATE={build_date_formatted}");

    // emit config
    generate_config("esp-bootloader-support-esp-idf", &[
        (
            "mmu_page_size",
