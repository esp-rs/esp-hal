...
- The `InitializationError::General` is replaced by `InitializationError::Internal`
- The `WifiError::InternalError` is removed and `InternalWifiError` was folded into `WifiError`, some variants renamed for clarity
