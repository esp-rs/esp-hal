...
//! kept up to date after Light-sleep or Deep-sleep.
//! 
//! The driver supports features such as retrieving the current system time, setting alarms
//! for specific time points or periodic intervals, enabling and clearing interrupts,
//! configuring various settings of the system timer.
//!
//! By using the SYSTIME peripheral driver, you can leverage the system timer functionality
//! of ESP chips for accurate timing measurements, event triggering
//! and synchronization in your applications.
//! 
//! ## Example
//! ```no_run
