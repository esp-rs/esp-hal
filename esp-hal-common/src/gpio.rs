...
//! 
//! This driver supports various operations on GPIO pins, including setting the pin mode, direction,
//! and manipulating the pin state (setting high/low, toggling). It provides an interface to interact
//! with GPIO pins on ESP chips, allowing developers to control and read the state of the pins.
//! This module also implements a number of traits from [embedded-hal] to provide a common interface for GPIO pins.
//! 
