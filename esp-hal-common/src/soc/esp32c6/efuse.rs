...
//! ## Overview
//! 
//! The `efuse` module is part of the `SOC (System-on-Chip)` funtionality of the `ESP32-C6` chip.
//! This module provides functionality for reading eFuse data from the `ESP32-C6` chip, allowing
