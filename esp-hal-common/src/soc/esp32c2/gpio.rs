...
//! on the `ESP32-C2` chip. It allows you to configure pins as inputs or outputs, set their state and read their state.
//! 
//! Let's get through the functionality and configurations provided by this GPIO module:
//!   - `get_io_mux_reg(gpio_num: u8) -> &'static crate::peripherals::io_mux::GPIO`: 
