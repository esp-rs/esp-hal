...
//! ## Overview
//! 
//! This module is part of the `SOC (System-on-Chip)` functionality of the `ESP32-S3` chip.
//! It module provides essential functionality for controlling and managing the CPU cores on the `ESP32-S3` chip
