...
//! ## Overview
//! 
//! The `Peripherals` module is a part of the `SOC` functionality of `ESP32-S3` chip. It provides singleton instances
...
//! components on the `ESP32-S3` chip, such as timers, `GPIO` pins, `I2C`, `SPI`, `UART`, and more.
