...
//!
//! ## Overview
//! The rom driver provides functionality related to the ROM (Read-Only Memory)
//! on ESP chips. It includes implementations for the [CRC (Cyclic Redundancy
//! Check)] and [MD5 (Message Digest 5)] algorithms.
//!
...
//!
//! This module also implements `MD5` algorithm, which is widely used for
