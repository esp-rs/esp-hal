...
const I2C_BBPLL_OC_DCHGP_LSB: u32 = 4; // CHECKME
const I2C_BBPLL_OC_DCHGP_MSB: u32 = 6; // CHECKME
...
const I2C_BBPLL_OC_DCUR_MSB: u8 = 2; // potentially deleted
const I2C_BBPLL_OC_DCUR_LSB: u8 = 0; // potentially deleted
...
fn regi2c_enable_block(block: u8) {
    ...
    reg_set_bit(I2C_MST_DATE_REG, I2C_ANA_MST_I2C_MAT_CLK_EN);
    ...
    match block {
        ...
        REGI2C_DIG_REG => {
            reg_set_bit(LP_I2C_ANA_MST_DEVICE_EN_REG, REGI2C_PMU_REG_DEVICE_EN);
        }
        REGI2C_ULP_CAL => {
...
fn regi2c_disable_block(block: u8) {
    match block {
        ...
        REGI2C_DIG_REG => {
            reg_clr_bit(LP_I2C_ANA_MST_DEVICE_EN_REG, REGI2C_PMU_REG_DEVICE_EN);
        }
        REGI2C_ULP_CAL => {
