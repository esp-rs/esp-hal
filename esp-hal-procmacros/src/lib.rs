...
//! 
//! ## Overview
//! The `esp-hal-procmacros` module provides procedural macros for placing statics and functions into RAM and for marking
//! interrupt handlers on ESP microcontrollers. 
//! 
//! These macros offer developers a convenient way to control memory placement and define interrupt handlers
//! in their embedded applications, allowing for optimized memory usage and precise handling of hardware interrupts.
//! 
//! Key Components:
//!   - [ram](attr.ram.html) - Attribute macro for placing statics and functions into specific memory sections, such as 
//!     SRAM or RTC RAM (slow or fast) with different initialization options. Supported opitons are:
...
//!  - [interrupt](attr.interrupt.html) - Attribute macro for marking interrupt handlers. Interrupt handlers are used
//!    to handle specific hardware interrupts generated by peripherals.<br>
