...
pub fn interrupt(args: TokenStream, input: TokenStream) -> TokenStream {
    crate::interrupt::interrupt(args, input, false)
}

/// THIS IS NOT MEANT TO BE USED OUTSIDE OF ESP_HAL CRATES!
#[cfg(feature = "interrupt")]
#[proc_macro_attribute]
pub fn interrupt_internal(args: TokenStream, input: TokenStream) -> TokenStream {
    crate::interrupt::interrupt(args, input, true)
}
