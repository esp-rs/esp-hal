...
pub fn block_version() -> (u8, u8) {
    // see <https://github.com/espressif/esp-idf/blob/1e76669/components/hal/esp32c61/include/hal/efuse_ll.h#L117-L125>
    // https://github.com/espressif/esp-idf/blob/1e76669/components/efuse/esp32c61/esp_efuse_table.csv#L163
    (
...
pub fn rtc_calib_init_code(_unit: AdcCalibUnit, atten: Attenuation) -> Option<u16> {
    ...
    let init_code: u16 = super::read_field_le(match atten {
        Attenuation::_0dB => ADC1_AVE_INIT_CODE_ATTEN0,
        Attenuation::_2p5dB => ADC1_AVE_INIT_CODE_ATTEN1,
        Attenuation::_6dB => ADC1_AVE_INIT_CODE_ATTEN2,
        Attenuation::_11dB => ADC1_AVE_INIT_CODE_ATTEN3,
    });
