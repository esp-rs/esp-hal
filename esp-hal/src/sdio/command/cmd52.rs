...
impl Cmd52 {
    ...
    /// Gets the read-write flag.
    pub fn read_after_write_flag(&self) -> RawFlag {
        RawFlag::from_bool(self._raw_flag())
    }

    /// Sets the read-write flag.
    pub fn set_read_after_write_flag(&mut self, flag: RawFlag) {
        self._set_raw_flag(flag.into_bool());
    }

    /// Gets the register address.
    pub fn register_address(&self) -> u16 {
        self._reg_addr() as u16
    }
