...
impl Pins {
        ...
        DATA3: Into<interconnect::OutputSignal<'d3>>,
    {
        Self {
            mode,
            clk_sclk: Self::connect_pin(clk_sclk.into(), OutputSignal::SD_CLK, None),
            cmd_mosi: Self::connect_pin(
                cmd_mosi.into(),
                OutputSignal::SD_CMD,
                Some(InputSignal::SD_CMD),
            ),
            dat0_miso: Self::connect_pin(
                dat0_miso.into(),
                OutputSignal::SD_DATA0,
                Some(InputSignal::SD_DATA0),
            ),
            dat1_irq: Self::connect_pin(
                dat1_irq.into(),
                OutputSignal::SD_DATA1,
                Some(InputSignal::SD_DATA1),
            ),
            dat2: Self::connect_pin(
                dat2.into(),
                OutputSignal::SD_DATA2,
                Some(InputSignal::SD_DATA2),
            ),
            dat3_cs: Self::connect_pin(
                dat3_cs.into(),
                OutputSignal::SD_DATA3,
                Some(InputSignal::SD_DATA3),
            ),
        }
    }
