    ...
    M: Mode,
{
    ...
    fn with_rx(self, rx: impl Peripheral<P = impl Into<InputConnection> + 'd> + 'd) -> Self {
        crate::into_ref!(rx);
    ...
    fn with_tx(self, tx: impl Peripheral<P = impl Into<OutputConnection> + 'd> + 'd) -> Self {
        crate::into_ref!(tx);
    ...
    M: Mode,
{
    ...
    /// Configure RTS pin
    pub fn with_rts(self, rts: impl Peripheral<P = impl Into<OutputConnection> + 'd> + 'd) -> Self {
        crate::into_ref!(rts);
    ...
    T: Instance + 'd,
{
    ...
    pub fn new(
        ...
        tx: impl Peripheral<P = impl Into<OutputConnection> + 'd> + 'd,
    ) -> Result<Self, Error> {
    ...
    M: Mode,
{
    ...
    /// Configure CTS pin
    pub fn with_cts(self, cts: impl Peripheral<P = impl Into<InputConnection> + 'd> + 'd) -> Self {
        crate::into_ref!(cts);
    ...
    T: Instance + 'd,
{
    ...
    pub fn new(
        uart: impl Peripheral<P = T> + 'd,
        rx: impl Peripheral<P = impl Into<InputConnection> + 'd> + 'd,
    ) -> Result<Self, Error> {
