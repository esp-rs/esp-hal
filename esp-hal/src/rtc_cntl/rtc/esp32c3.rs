...
/// against ESP-IDF - around 0.5% on the parts measured so far.
///
/// ESP-IDF only does this coming out of a power-on reset; on any other reset the RTC domain still
/// holds the trim. Blocks older than version 1 carry no measured code, and are calibrated by a
/// software sweep that is not implemented here.
///
/// See `set_ocode_by_efuse` in
/// <https://github.com/espressif/esp-idf/blob/v6.1/components/esp_hw_support/port/esp32c3/rtc_init.c>
fn calibrate_ocode() {
