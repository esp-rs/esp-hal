...
impl Ext1WakeupSource<'_, '_> {
    ...
    fn wake_io_reset() {
        use crate::{gpio::RtcPin, peripherals};
        ...
        uninit_pin(unsafe { peripherals::GPIO0::steal() }, wakeup_pins);
        uninit_pin(unsafe { peripherals::GPIO1::steal() }, wakeup_pins);
        uninit_pin(unsafe { peripherals::GPIO2::steal() }, wakeup_pins);
        uninit_pin(unsafe { peripherals::GPIO3::steal() }, wakeup_pins);
        uninit_pin(unsafe { peripherals::GPIO4::steal() }, wakeup_pins);
        uninit_pin(unsafe { peripherals::GPIO5::steal() }, wakeup_pins);
        uninit_pin(unsafe { peripherals::GPIO6::steal() }, wakeup_pins);
        uninit_pin(unsafe { peripherals::GPIO7::steal() }, wakeup_pins);
    }
}
