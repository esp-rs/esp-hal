//! Sleep frames of the ESP32-C6 and the ESP32-H2.
//!
...
macro_rules! non_critical_frame {
    ($($field:ident = $csr:expr),* $(,)?) => {
        ...
        /// `components/esp_hw_support/lowpower/port/esp32c6/rvsleep-frames.h`.
        #[repr(C)]
...
const _: () = ::core::assert!(size_of::<NonCriticalSleepFrame>() == 73 * 4);
