//! Sleep frames of the ESP32-S31 RISC-V core.
...
/// `components/esp_hw_support/lowpower/port/esp32s31/rvsleep-frames.h`. The assembly addresses the
...
const _: () = ::core::assert!(size_of::<CriticalSleepFrame>() == 73 * 4);
...
const _: () = ::core::assert!(size_of::<NonCriticalSleepFrame>() == 70 * 4);
