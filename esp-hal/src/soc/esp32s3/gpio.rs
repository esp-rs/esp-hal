...
crate::gpio! {
    ...
    (8, 0, [Input, Output, Analog] () (3 => SUBSPICS1))
    (9, 0, [Input, Output, Analog] (3 => SUBSPIHD 4 => FSPIHD) (3 => SUBSPIHD 4 => FSPIHD))
    (10, 0, [Input, Output, Analog] (2 => FSPIIO4 4 => FSPICS0) (2 => FSPIIO4 3 => SUBSPICS0 4 => FSPICS0))
    (11, 0, [Input, Output, Analog] (2 => FSPIIO5 3 => SUBSPID 4 => FSPID) (2 => FSPIIO5 3 => SUBSPID 4 => FSPID))
    (12, 0, [Input, Output, Analog] (2 => FSPIIO6 4 => FSPICLK) (2 => FSPIIO6 3=> SUBSPICLK 4 => FSPICLK))
    (13, 0, [Input, Output, Analog] (2 => FSPIIO7 3 => SUBSPIQ 4 => FSPIQ) (2 => FSPIIO7 3 => SUBSPIQ 4 => FSPIQ))
    (14, 0, [Input, Output, Analog] (3 => SUBSPIWP 4 => FSPIWP) (2 => FSPIDQS 3 => SUBSPIWP 4 => FSPIWP))
    (15, 0, [Input, Output, Analog] () (2 => U0RTS))
    (16, 0, [Input, Output, Analog] (2 => U0CTS) ())
    (17, 0, [Input, Output, Analog] () (2 => U1TXD))
    (18, 0, [Input, Output, Analog] (2 => U1RXD) ())
    (19, 0, [Input, Output, Analog] () (2 => U1RTS))
    (20, 0, [Input, Output, Analog] (2 => U1CTS) ())
