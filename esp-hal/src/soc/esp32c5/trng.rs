...
// See <https://github.com/espressif/esp-idf/blob/8d7d8aef588/components/hal/esp32c5/include/hal/rng_ll.h#L89-L96>
...
/// Blocks `ADC` usage.
// See <https://github.com/espressif/esp-idf/blob/8d7d8aef588/components/bootloader_support/src/bootloader_random_esp32c5.c#L21-L71>
pub(crate) fn ensure_randomness() {
    ...
    regi2c::ADC_SAR_ENT_PERIF.write_field(1);
    regi2c::ADC_SAR1_EN_TOUT.write_field(1);
    regi2c::ADC_SAR2_EN_TOUT.write_field(1);
...
// See <https://github.com/espressif/esp-idf/blob/8d7d8aef588/components/bootloader_support/src/bootloader_random_esp32c5.c#L73-L89>
pub(crate) fn revert_trng() {
    ...
    regi2c::ADC_SAR_DTEST_RTC.write_field(0);
    regi2c::ADC_SAR_ENT_PERIF.write_field(0);
    regi2c::ADC_SAR1_EN_TOUT.write_field(0);
    regi2c::ADC_SAR2_EN_TOUT.write_field(0);
