...
impl<'d> I2c<'d, Async> {
    ...
    pub async fn write_async<A: Into<I2cAddress>>(
        ...
        self.driver()
            .write(address.into(), buffer.as_ref(), true, true)
            .await
            .inspect_err(|_| self.internal_recover())
    }
    ...
    pub async fn read_async<A: Into<I2cAddress>>(
        ...
        self.driver()
            .read(address.into(), buffer.as_mut(), true, true, false)
            .await
            .inspect_err(|_| self.internal_recover())
    }
    ...
    pub async fn write_read_async<A: Into<I2cAddress>>(
        &mut self,
        address: A,
        write_buffer: impl AsRef<[u8]>,
        mut read_buffer: impl AsMut<[u8]>,
    ) -> Result<(), Error> {
        self.driver()
            .write_read(address.into(), write_buffer.as_ref(), read_buffer.as_mut())
            .await
            .inspect_err(|_| self.internal_recover())
    }
    ...
    Dm: DriverMode,
{
    ...
    /// # }
    /// ```
    pub fn write<A: Into<I2cAddress>>(
        &mut self,
        address: A,
        buffer: impl AsRef<[u8]>,
    ) -> Result<(), Error> {
        self.driver()
            .write_blocking(address.into(), buffer.as_ref(), true, true)
            .inspect_err(|_| self.internal_recover())
    }
    ...
    pub fn read<A: Into<I2cAddress>>(
        ...
        self.driver()
            .read_blocking(address.into(), buffer.as_mut(), true, true, false)
            .inspect_err(|_| self.internal_recover())
    }
    ...
    pub fn write_read<A: Into<I2cAddress>>(
        ...
        self.driver()
            .write_read_blocking(address.into(), write_buffer.as_ref(), read_buffer.as_mut())
            .inspect_err(|_| self.internal_recover())
    }
