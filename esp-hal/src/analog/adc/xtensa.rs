...
pub trait RegisterAccess {
    ...
    ///
    /// The hardware subtracts this code before the result is truncated, so it has to be
    /// programmed regardless of the calibration scheme - otherwise the usable output range
