...
mod ctrlr_ll {
    ...
    /// Sets the PSRAM address bit length
    #[inline(always)]
    ...
    /// Sets the PSRAM read dummy cycles
    #[inline(always)]
...
/// Sets the MSPI_FAST_CLK high-speed divider (valid when SOC_ROOT clock source is PLL)
#[inline(always)]
...
/// Sets the MSPI flash `din` number
#[inline(always)]
...
/// Sets the MSPI flash extra dummy cycles
#[inline(always)]
...
/// Sets the MSPI PSRAM `din` number
#[inline(always)]
...
/// Sets the MSPI PSRAM extra dummy cycles
#[inline(always)]
