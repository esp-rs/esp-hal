    ...
    DM: crate::Mode,
{
    fn new_internal(
        ...
        rx_pin: impl Peripheral<P = impl Into<InputConnection>> + 'd,
        tx_pin: impl Peripheral<P = impl Into<OutputConnection>> + 'd,
        baud_rate: BaudRate,
        no_transceiver: bool,
        mode: TwaiMode,
    ) -> Self {
        ...
        let mut tx_pin = tx_pin.map_into();
        let mut rx_pin = rx_pin.map_into();
