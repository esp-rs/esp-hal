...
#IF ESP_HAL_CONFIG_INSTRUCTION_CACHE_SIZE_8KB
...
#IF ESP_HAL_CONFIG_DATA_CACHE_SIZE_0KB
RESERVE_DCACHE = 0;
#ENDIF

#IF ESP_HAL_CONFIG_DATA_CACHE_SIZE_8KB
RESERVE_DCACHE = 0x2000;
#ENDIF

#IF ESP_HAL_CONFIG_DATA_CACHE_SIZE_16KB
