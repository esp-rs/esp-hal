...
- The `rmt::PulseCode::MAX_LEN` constant was added. (#XXXX)
...
- The behavior of `rmt::PulseCode` constructors (`new`, `new_clamped`, `try_new`) has been reworked to be more convenient and clear. (#XXXX)
