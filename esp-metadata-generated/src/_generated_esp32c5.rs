...
macro_rules! property {
    ...
    ("clock_tree.hp_root_clk") => {
        ...
        ::soc::clocks::HpRootClkConfig::PllF160m, crate
        ::soc::clocks::HpRootClkConfig::PllF240m]
    };
    ...
    ("clock_tree.lp_fast_clk") => {
        ...
        ::soc::clocks::LpFastClkConfig::XtalD2, crate
    ...
    ("clock_tree.rmt.sclk") => {
        [crate ::soc::clocks::RmtSclkConfig::XtalClk, crate
            ...
            pub fn configure_function_clock(
                ...
                if clocks.spi_function_clock_refcount[self as usize] > 0 {
                    match new_selector {
                        ...
                        SpiFunctionClockConfig::PllF160m => request_pll_f160m(clocks),
                        SpiFunctionClockConfig::PllF120m => request_pll_f120m(clocks),
                    ...
                    if let Some(old_selector) = old_selector {
                        match old_selector {
                            ...
                            SpiFunctionClockConfig::PllF160m => release_pll_f160m(clocks),
                            SpiFunctionClockConfig::PllF120m => release_pll_f120m(clocks),
...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        (LP_GPIO(unstable)), (LP_I2C0(unstable)), (LP_I2C_ANA_MST(unstable)),
...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        => {} } _for_each_inner_lp_function!((LP_UART_DTRN, GPIO0, _0));
        _for_each_inner_lp_function!((LP_GPIO0, GPIO0, _1));
        _for_each_inner_lp_function!((LP_UART_DSRN, GPIO1, _0));
        _for_each_inner_lp_function!((LP_GPIO1, GPIO1, _1));
        _for_each_inner_lp_function!((LP_UART_RTSN, GPIO2, _0));
        _for_each_inner_lp_function!((LP_GPIO2, GPIO2, _1));
        _for_each_inner_lp_function!((LP_I2C_SDA, GPIO2, _3));
        _for_each_inner_lp_function!((LP_UART_CTSN, GPIO3, _0));
        _for_each_inner_lp_function!((LP_GPIO3, GPIO3, _1));
        _for_each_inner_lp_function!((LP_I2C_SCL, GPIO3, _3));
        _for_each_inner_lp_function!((LP_UART_RXD, GPIO4, _0));
        _for_each_inner_lp_function!((LP_GPIO4, GPIO4, _1));
        _for_each_inner_lp_function!((LP_UART_TXD, GPIO5, _0));
        ...
        _for_each_inner_lp_function!((all(LP_UART_DTRN, GPIO0, _0), (LP_GPIO0, GPIO0,
        _1), (LP_UART_DSRN, GPIO1, _0), (LP_GPIO1, GPIO1, _1), (LP_UART_RTSN, GPIO2, _0),
        (LP_GPIO2, GPIO2, _1), (LP_I2C_SDA, GPIO2, _3), (LP_UART_CTSN, GPIO3, _0),
        (LP_GPIO3, GPIO3, _1), (LP_I2C_SCL, GPIO3, _3), (LP_UART_RXD, GPIO4, _0),
        (LP_GPIO4, GPIO4, _1), (LP_UART_TXD, GPIO5, _0), (LP_GPIO5, GPIO5, _1),
        (LP_GPIO6, GPIO6, _1))); _for_each_inner_lp_function!((LP_GPIOn((LP_GPIO0,
        ...
        GPIO5, _1, () ()), ((LP_GPIO6, LP_GPIOn, 6), GPIO6, _1, () ())));
    };
}
