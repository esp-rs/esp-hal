...
impl Chip {
        ...
        match self {
            ...
            Self::Esp32c5 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=lp_io_version=\"unsupported\"",
            ...
            Self::Esp32c6 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=ledc_channel_count=\"6\"",
                    "cargo:rustc-cfg=lp_i2c_master_fifo_size=\"16\"",
                    "cargo:rustc-cfg=lp_io_version=\"esp32c6\"",
                    "cargo:rustc-cfg=lp_uart_ram_size=\"32\"",
    ...
    pub fn all_possible_symbols() -> &'static [&'static str] {
        &[
            ...
            "lp_io_version, \
             values(\"esp32\",\"v3\",\"unsupported\",\"esp32c6\",\"esp32h2\",\"esp32p4\",\"v2\")",
            "psram_extmem_origin, \
            ...
            "lp_i2c_master_fifo_size, values(\"16\",\"32\")",
