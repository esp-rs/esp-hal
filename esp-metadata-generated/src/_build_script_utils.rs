        ...
        match self {
            Self::Esp32 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_cpu_csr_set_is_set",
            ...
            Self::Esp32c6 => Config {
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=soc_cpu_csr_prv_mode_is_set",
                    "cargo:rustc-cfg=cpu_csr_set=\"esp_riscv\"",
                    "cargo:rustc-cfg=soc_cpu_csr_set_is_set",
                    "cargo:rustc-cfg=soc_has_swd_watchdog",
                    "cargo:rustc-cfg=soc_cpu_mcause_mask=\"31\"",
                    "cargo:rustc-cfg=soc_has_clock_node_xtal_clk",
            ...
            Self::Esp32h2 => Config {
                ...
                symbols: &[
                    ...
                    "sleep_has_wakeup_source_lp_core",
                    "sleep_pd_retention",
                    "sleep_regdma_sw_trigger",
                    "sleep_regdma_wait_ops",
                    "soc_cpu_has_csr_pc",
                    "soc_cpu_csr_prv_mode=\"3088\"",
                    "soc_cpu_csr_prv_mode_is_set",
                    "cpu_csr_set=\"esp_riscv\"",
                ...
                cfgs: &[
                    ...
                    "cargo:rustc-cfg=sleep_has_wakeup_source_lp_core",
                    "cargo:rustc-cfg=sleep_pd_retention",
                    "cargo:rustc-cfg=sleep_regdma_sw_trigger",
                    "cargo:rustc-cfg=sleep_regdma_wait_ops",
                    "cargo:rustc-cfg=soc_cpu_has_csr_pc",
                    "cargo:rustc-cfg=soc_cpu_csr_prv_mode=\"3088\"",
                    "cargo:rustc-cfg=soc_cpu_csr_prv_mode_is_set",
                    "cargo:rustc-cfg=cpu_csr_set=\"esp_riscv\"",
