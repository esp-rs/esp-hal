...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_lp_function!((RTC_GPIO6, GPIO6, _0));
        _for_each_inner_lp_function!((RTC_GPIO7, GPIO7, _0));
        _for_each_inner_lp_function!((RTC_GPIO8, GPIO8, _0));
        _for_each_inner_lp_function!((RTC_GPIO9, GPIO9, _0));
        _for_each_inner_lp_function!((RTC_GPIO10, GPIO10, _0));
        _for_each_inner_lp_function!((RTC_GPIO11, GPIO11, _0));
        _for_each_inner_lp_function!((RTC_GPIO12, GPIO12, _0));
        _for_each_inner_lp_function!((RTC_GPIO13, GPIO13, _0));
        _for_each_inner_lp_function!((RTC_GPIO14, GPIO14, _0));
        _for_each_inner_lp_function!((RTC_GPIO15, GPIO15, _0));
        _for_each_inner_lp_function!((RTC_GPIO16, GPIO16, _0));
        _for_each_inner_lp_function!((RTC_GPIO17, GPIO17, _0));
        _for_each_inner_lp_function!((RTC_GPIO18, GPIO18, _0));
        _for_each_inner_lp_function!((RTC_GPIO19, GPIO19, _0));
        _for_each_inner_lp_function!((RTC_GPIO20, GPIO20, _0));
        _for_each_inner_lp_function!((RTC_GPIO21, GPIO21, _0));
        ...
        _for_each_inner_lp_function!(((RTC_GPIO6, RTC_GPIOn, 6), GPIO6, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO7, RTC_GPIOn, 7), GPIO7, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO8, RTC_GPIOn, 8), GPIO8, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO9, RTC_GPIOn, 9), GPIO9, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO10, RTC_GPIOn, 10), GPIO10, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO11, RTC_GPIOn, 11), GPIO11, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO12, RTC_GPIOn, 12), GPIO12, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO13, RTC_GPIOn, 13), GPIO13, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO14, RTC_GPIOn, 14), GPIO14, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO15, RTC_GPIOn, 15), GPIO15, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO16, RTC_GPIOn, 16), GPIO16, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO17, RTC_GPIOn, 17), GPIO17, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO18, RTC_GPIOn, 18), GPIO18, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO19, RTC_GPIOn, 19), GPIO19, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO20, RTC_GPIOn, 20), GPIO20, _0, () ()));
        _for_each_inner_lp_function!(((RTC_GPIO21, RTC_GPIOn, 21), GPIO21, _0, () ()));
        ...
        GPIO3, _3, () ())); _for_each_inner_lp_function!((all(RTC_GPIO0, GPIO0, _0),
        (SAR_I2C_SCL_0, GPIO0, _3), (RTC_GPIO1, GPIO1, _0), (SAR_I2C_SDA_0, GPIO1, _3),
        (RTC_GPIO2, GPIO2, _0), (SAR_I2C_SCL_1, GPIO2, _3), (RTC_GPIO3, GPIO3, _0),
        (SAR_I2C_SDA_1, GPIO3, _3), (RTC_GPIO4, GPIO4, _0), (RTC_GPIO5, GPIO5, _0),
        (RTC_GPIO6, GPIO6, _0), (RTC_GPIO7, GPIO7, _0), (RTC_GPIO8, GPIO8, _0),
        (RTC_GPIO9, GPIO9, _0), (RTC_GPIO10, GPIO10, _0), (RTC_GPIO11, GPIO11, _0),
        (RTC_GPIO12, GPIO12, _0), (RTC_GPIO13, GPIO13, _0), (RTC_GPIO14, GPIO14, _0),
        (RTC_GPIO15, GPIO15, _0), (RTC_GPIO16, GPIO16, _0), (RTC_GPIO17, GPIO17, _0),
        (RTC_GPIO18, GPIO18, _0), (RTC_GPIO19, GPIO19, _0), (RTC_GPIO20, GPIO20, _0),
        (RTC_GPIO21, GPIO21, _0))); _for_each_inner_lp_function!((RTC_GPIOn((RTC_GPIO0,
        ...
        RTC_GPIOn, 5), GPIO5, _0, () ()), ((RTC_GPIO6, RTC_GPIOn, 6), GPIO6, _0, () ()),
        ((RTC_GPIO7, RTC_GPIOn, 7), GPIO7, _0, () ()), ((RTC_GPIO8, RTC_GPIOn, 8), GPIO8,
        _0, () ()), ((RTC_GPIO9, RTC_GPIOn, 9), GPIO9, _0, () ()), ((RTC_GPIO10,
        RTC_GPIOn, 10), GPIO10, _0, () ()), ((RTC_GPIO11, RTC_GPIOn, 11), GPIO11, _0, ()
        ()), ((RTC_GPIO12, RTC_GPIOn, 12), GPIO12, _0, () ()), ((RTC_GPIO13, RTC_GPIOn,
        13), GPIO13, _0, () ()), ((RTC_GPIO14, RTC_GPIOn, 14), GPIO14, _0, () ()),
        ((RTC_GPIO15, RTC_GPIOn, 15), GPIO15, _0, () ()), ((RTC_GPIO16, RTC_GPIOn, 16),
        GPIO16, _0, () ()), ((RTC_GPIO17, RTC_GPIOn, 17), GPIO17, _0, () ()),
        ((RTC_GPIO18, RTC_GPIOn, 18), GPIO18, _0, () ()), ((RTC_GPIO19, RTC_GPIOn, 19),
        GPIO19, _0, () ()), ((RTC_GPIO20, RTC_GPIOn, 20), GPIO20, _0, () ()),
        ((RTC_GPIO21, RTC_GPIOn, 21), GPIO21, _0, () ())));
