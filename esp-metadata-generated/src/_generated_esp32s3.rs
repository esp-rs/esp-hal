...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        1, () ())); _for_each_inner_lp_function!(((SAR_I2C_SDA_1, SAR_I2C_SDA_n, 1),
        GPIO3, 1, () ())); _for_each_inner_lp_function!((all(RTC_GPIO0, GPIO0, 0),
        (SAR_I2C_SCL_0, GPIO0, 1), (RTC_GPIO1, GPIO1, 0), (SAR_I2C_SDA_0, GPIO1, 1),
        (RTC_GPIO2, GPIO2, 0), (SAR_I2C_SCL_1, GPIO2, 1), (RTC_GPIO3, GPIO3, 0),
        (SAR_I2C_SDA_1, GPIO3, 1), (RTC_GPIO4, GPIO4, 0), (RTC_GPIO5, GPIO5, 0),
        (RTC_GPIO6, GPIO6, 0), (RTC_GPIO7, GPIO7, 0), (RTC_GPIO8, GPIO8, 0), (RTC_GPIO9,
        GPIO9, 0), (RTC_GPIO10, GPIO10, 0), (RTC_GPIO11, GPIO11, 0), (RTC_GPIO12, GPIO12,
        0), (RTC_GPIO13, GPIO13, 0), (RTC_GPIO14, GPIO14, 0), (RTC_GPIO15, GPIO15, 0),
        (RTC_GPIO16, GPIO16, 0), (RTC_GPIO17, GPIO17, 0), (RTC_GPIO18, GPIO18, 0),
        (RTC_GPIO19, GPIO19, 0), (RTC_GPIO20, GPIO20, 0), (RTC_GPIO21, GPIO21, 0)));
        _for_each_inner_lp_function!((RTC_GPIOn((RTC_GPIO0, RTC_GPIOn, 0), GPIO0, 0, ()
        ()), ((RTC_GPIO1, RTC_GPIOn, 1), GPIO1, 0, () ()), ((RTC_GPIO2, RTC_GPIOn, 2),
        GPIO2, 0, () ()), ((RTC_GPIO3, RTC_GPIOn, 3), GPIO3, 0, () ()), ((RTC_GPIO4,
        RTC_GPIOn, 4), GPIO4, 0, () ()), ((RTC_GPIO5, RTC_GPIOn, 5), GPIO5, 0, () ()),
        ((RTC_GPIO6, RTC_GPIOn, 6), GPIO6, 0, () ()), ((RTC_GPIO7, RTC_GPIOn, 7), GPIO7,
        0, () ()), ((RTC_GPIO8, RTC_GPIOn, 8), GPIO8, 0, () ()), ((RTC_GPIO9, RTC_GPIOn,
        9), GPIO9, 0, () ()), ((RTC_GPIO10, RTC_GPIOn, 10), GPIO10, 0, () ()),
        ((RTC_GPIO11, RTC_GPIOn, 11), GPIO11, 0, () ()), ((RTC_GPIO12, RTC_GPIOn, 12),
        GPIO12, 0, () ()), ((RTC_GPIO13, RTC_GPIOn, 13), GPIO13, 0, () ()), ((RTC_GPIO14,
        RTC_GPIOn, 14), GPIO14, 0, () ()), ((RTC_GPIO15, RTC_GPIOn, 15), GPIO15, 0, ()
        ()), ((RTC_GPIO16, RTC_GPIOn, 16), GPIO16, 0, () ()), ((RTC_GPIO17, RTC_GPIOn,
        17), GPIO17, 0, () ()), ((RTC_GPIO18, RTC_GPIOn, 18), GPIO18, 0, () ()),
        ((RTC_GPIO19, RTC_GPIOn, 19), GPIO19, 0, () ()), ((RTC_GPIO20, RTC_GPIOn, 20),
        GPIO20, 0, () ()), ((RTC_GPIO21, RTC_GPIOn, 21), GPIO21, 0, () ())));
        _for_each_inner_lp_function!((SAR_I2C_SCL_n((SAR_I2C_SCL_0, SAR_I2C_SCL_n, 0),
        GPIO0, 1, () ()), ((SAR_I2C_SCL_1, SAR_I2C_SCL_n, 1), GPIO2, 1, () ())));
