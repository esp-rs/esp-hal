...
macro_rules! impl_for_pin_type {
    (
        ...
        $otherwise }), 26 => if_pin_is_type!((GPIO26, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO26::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 27 => if_pin_is_type!((GPIO27, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO27::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 28 => if_pin_is_type!((GPIO28, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO28::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 29 => if_pin_is_type!((GPIO29, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO29::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 30 => if_pin_is_type!((GPIO30, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO30::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 31 => if_pin_is_type!((GPIO31, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO31::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 32 => if_pin_is_type!((GPIO32, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO32::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 33 => if_pin_is_type!((GPIO33, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO33::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 34 => if_pin_is_type!((GPIO34, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO34::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 35 => if_pin_is_type!((GPIO35, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO35::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 36 => if_pin_is_type!((GPIO36, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO36::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 37 => if_pin_is_type!((GPIO37, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO37::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 38 => if_pin_is_type!((GPIO38, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO38::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 39 => if_pin_is_type!((GPIO39, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO39::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 40 => if_pin_is_type!((GPIO40, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO40::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 41 => if_pin_is_type!((GPIO41, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO41::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 42 => if_pin_is_type!((GPIO42, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO42::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 43 => if_pin_is_type!((GPIO43, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO43::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 44 => if_pin_is_type!((GPIO44, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO44::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 45 => if_pin_is_type!((GPIO45, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO45::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 46 => if_pin_is_type!((GPIO46, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO46::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 47 => if_pin_is_type!((GPIO47, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO47::steal() }; #[allow(unused_braces)] $code } } else {
        $otherwise }), 48 => if_pin_is_type!((GPIO48, $on_type) => { {
        #[allow(unused_unsafe, unused_mut)] let mut $inner_ident = unsafe { crate
        ::peripherals::GPIO48::steal() }; #[allow(unused_braces)] $code } } else {
