...
macro_rules! property {
    ...
    ("clock_tree.ble_lp_clk") => {
        ...
        ::soc::clocks::BleLpClkConfig::RtcSlow]
    };
    ...
    ("clock_tree.i2s.tx_clk.sclk") => {
        [crate ::soc::clocks::I2sClkSclk::Xtal, crate ::soc::clocks::I2sClkSclk::PllD2,
        crate ::soc::clocks::I2sClkSclk::Pll160m]
    };
...
macro_rules! for_each_sdmmc {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        } _for_each_inner_sdmmc!((slot0, 0, false, [SDHOST_CCLK_OUT_1],
        [SDHOST_CCMD_IN_1], [SDHOST_CCMD_OUT_1], [SDHOST_CDATA_IN_10, SDHOST_CDATA_IN_11,
        SDHOST_CDATA_IN_12, SDHOST_CDATA_IN_13, SDHOST_CDATA_IN_14, SDHOST_CDATA_IN_15,
        SDHOST_CDATA_IN_16, SDHOST_CDATA_IN_17], [SDHOST_CDATA_OUT_10,
        SDHOST_CDATA_OUT_11, SDHOST_CDATA_OUT_12, SDHOST_CDATA_OUT_13,
        SDHOST_CDATA_OUT_14, SDHOST_CDATA_OUT_15, SDHOST_CDATA_OUT_16,
        SDHOST_CDATA_OUT_17], [SDHOST_CARD_DETECT_N_1], [SDHOST_CARD_WRITE_PRT_1],
        [SDHOST_CARD_INT_N_1], [SDHOST_DATA_STROBE_1], [SDHOST_RST_N_1]));
        _for_each_inner_sdmmc!((slot1, 1, false, [SDHOST_CCLK_OUT_2], [SDHOST_CCMD_IN_2],
        [SDHOST_CCMD_OUT_2], [SDHOST_CDATA_IN_20, SDHOST_CDATA_IN_21, SDHOST_CDATA_IN_22,
        SDHOST_CDATA_IN_23, SDHOST_CDATA_IN_24, SDHOST_CDATA_IN_25, SDHOST_CDATA_IN_26,
        SDHOST_CDATA_IN_27], [SDHOST_CDATA_OUT_20, SDHOST_CDATA_OUT_21,
        SDHOST_CDATA_OUT_22, SDHOST_CDATA_OUT_23, SDHOST_CDATA_OUT_24,
        SDHOST_CDATA_OUT_25, SDHOST_CDATA_OUT_26, SDHOST_CDATA_OUT_27],
        [SDHOST_CARD_DETECT_N_2], [SDHOST_CARD_WRITE_PRT_2], [SDHOST_CARD_INT_N_2],
        [SDHOST_DATA_STROBE_2], [SDHOST_RST_N_2])); _for_each_inner_sdmmc!((all(slot0, 0,
        false, [SDHOST_CCLK_OUT_1], [SDHOST_CCMD_IN_1], [SDHOST_CCMD_OUT_1],
        [SDHOST_CDATA_IN_10, SDHOST_CDATA_IN_11, SDHOST_CDATA_IN_12, SDHOST_CDATA_IN_13,
        SDHOST_CDATA_IN_14, SDHOST_CDATA_IN_15, SDHOST_CDATA_IN_16, SDHOST_CDATA_IN_17],
        [SDHOST_CDATA_OUT_10, SDHOST_CDATA_OUT_11, SDHOST_CDATA_OUT_12,
        SDHOST_CDATA_OUT_13, SDHOST_CDATA_OUT_14, SDHOST_CDATA_OUT_15,
        SDHOST_CDATA_OUT_16, SDHOST_CDATA_OUT_17], [SDHOST_CARD_DETECT_N_1],
        [SDHOST_CARD_WRITE_PRT_1], [SDHOST_CARD_INT_N_1], [SDHOST_DATA_STROBE_1],
        [SDHOST_RST_N_1]), (slot1, 1, false, [SDHOST_CCLK_OUT_2], [SDHOST_CCMD_IN_2],
        [SDHOST_CCMD_OUT_2], [SDHOST_CDATA_IN_20, SDHOST_CDATA_IN_21, SDHOST_CDATA_IN_22,
        SDHOST_CDATA_IN_23, SDHOST_CDATA_IN_24, SDHOST_CDATA_IN_25, SDHOST_CDATA_IN_26,
        SDHOST_CDATA_IN_27], [SDHOST_CDATA_OUT_20, SDHOST_CDATA_OUT_21,
        SDHOST_CDATA_OUT_22, SDHOST_CDATA_OUT_23, SDHOST_CDATA_OUT_24,
        SDHOST_CDATA_OUT_25, SDHOST_CDATA_OUT_26, SDHOST_CDATA_OUT_27],
        [SDHOST_CARD_DETECT_N_2], [SDHOST_CARD_WRITE_PRT_2], [SDHOST_CARD_INT_N_2],
        [SDHOST_DATA_STROBE_2], [SDHOST_RST_N_2])));
    };
}
#[macro_export]
#[cfg_attr(docsrs, doc(cfg(feature = "_device-selected")))]
...
macro_rules! for_each_mem2mem_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        DMA_CH3, 0)); _for_each_inner_mem2mem_channel!(("AHB_GDMA", AhbGdma,
        AhbGdmaChannel, DMA_CH4, 0)); _for_each_inner_mem2mem_channel!(("AHB_GDMA",
        AhbGdma, AhbGdmaChannel, 0, 0, 1, 0, 2, 0, 3, 0, 4, 0));
        ...
        DMA_CH0, 0), ("AHB_GDMA", AhbGdma, AhbGdmaChannel, DMA_CH1, 0), ("AHB_GDMA",
        AhbGdma, AhbGdmaChannel, DMA_CH2, 0), ("AHB_GDMA", AhbGdma, AhbGdmaChannel,
        DMA_CH3, 0), ("AHB_GDMA", AhbGdma, AhbGdmaChannel, DMA_CH4, 0)));
...
macro_rules! define_clock_tree_types {
    () => {
        ...
        impl LcdCamLcdClockConfig {
            ...
            pub fn sclk(self) -> LcdCamLcdClockSclk {
                self.sclk
            }
            pub fn div_num(self) -> u32 {
                self.div_num as u32
        ...
        impl LcdCamCamClockConfig {
            ...
            pub fn sclk(self) -> LcdCamCamClockSclk {
                self.sclk
            }
            pub fn div_num(self) -> u32 {
                self.div_num as u32
        ...
        /// Returns the clock source that `RC_FAST_DIV_CLK` currently runs on.
        pub fn rc_fast_div_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            rc_fast_clk_root_source(clocks)
        }
        /// Returns the clock source that `SYSTEM_PRE_DIV_IN` currently runs on.
        pub fn system_pre_div_in_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            let config = clocks.system_pre_div_in?;
            match config {
                SystemPreDivInConfig::Xtal => xtal_clk_root_source(clocks),
                SystemPreDivInConfig::RcFast => rc_fast_clk_root_source(clocks),
            }
        }
        /// Returns the clock source that `SYSTEM_PRE_DIV` currently runs on.
        pub fn system_pre_div_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            system_pre_div_in_root_source(clocks)
        }
        /// Returns the clock source that `CPU_PLL_DIV_OUT` currently runs on.
        pub fn cpu_pll_div_out_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
        ...
        pub fn cpu_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            ...
            match config {
                CpuClkConfig::Xtal => system_pre_div_root_source(clocks),
                CpuClkConfig::RcFast => system_pre_div_root_source(clocks),
                CpuClkConfig::Pll => cpu_pll_div_out_root_source(clocks),
            }
        }
        /// Returns the clock source that `PLL_D2` currently runs on.
        pub fn pll_d2_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            pll_clk_root_source(clocks)
        }
        /// Returns the clock source that `PLL_160M` currently runs on.
        pub fn pll_160m_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            cpu_clk_root_source(clocks)
        }
        /// Returns the clock source that `APB_80M` currently runs on.
        pub fn apb_80m_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            cpu_clk_root_source(clocks)
        }
        /// Returns the clock source that `RC_FAST_CLK_DIV_N` currently runs on.
        pub fn rc_fast_clk_div_n_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            rc_fast_clk_root_source(clocks)
        }
        /// Returns the clock source that `XTAL_DIV_CLK` currently runs on.
        pub fn xtal_div_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            xtal_clk_root_source(clocks)
        }
        /// Returns the clock source that `RTC_SLOW_CLK` currently runs on.
        pub fn rtc_slow_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            let config = clocks.rtc_slow_clk?;
            match config {
                #[cfg(use_xtal32k)]
                RtcSlowClkConfig::Xtal32k => xtal32k_clk_root_source(clocks),
                RtcSlowClkConfig::RcSlow => rc_slow_clk_root_source(clocks),
                RtcSlowClkConfig::RcFast => rc_fast_div_clk_root_source(clocks),
            }
        }
        ...
        pub fn ble_lp_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            ...
            match config {
                ...
                BleLpClkConfig::RtcSlow => rtc_slow_clk_root_source(clocks),
            }
        }
        /// Returns the clock source that `RTC_FAST_CLK` currently runs on.
        pub fn rtc_fast_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            let config = clocks.rtc_fast_clk?;
            match config {
                RtcFastClkConfig::Xtal => xtal_div_clk_root_source(clocks),
                RtcFastClkConfig::Rc => rc_fast_clk_div_n_root_source(clocks),
            }
        }
        /// Returns the clock source that `LOW_POWER_CLK` currently runs on.
        pub fn low_power_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            let config = clocks.low_power_clk?;
            match config {
                LowPowerClkConfig::Xtal => xtal_clk_root_source(clocks),
                LowPowerClkConfig::RcFast => rc_fast_clk_root_source(clocks),
                #[cfg(use_xtal32k)]
                LowPowerClkConfig::Xtal32k => xtal32k_clk_root_source(clocks),
                LowPowerClkConfig::RtcSlow => rtc_slow_clk_root_source(clocks),
            }
        }
        /// Returns the clock source that `UART_MEM_CLK` currently runs on.
        pub fn uart_mem_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            xtal_clk_root_source(clocks)
        }
        ...
        pub fn timg_calibration_clock_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            ...
            match config {
                ...
                TimgCalibrationClockConfig::RcFastDivClk => rc_fast_div_clk_root_source(clocks),
                #[cfg(use_xtal32k)]
        ...
        pub fn apb_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            let config = clocks.apb_clk?;
            match config {
                ApbClkConfig::Pll => apb_80m_root_source(clocks),
                ApbClkConfig::Cpu => cpu_clk_root_source(clocks),
            }
        }
        /// Returns the clock source that `CRYPTO_PWM_CLK` currently runs on.
        pub fn crypto_pwm_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            let config = clocks.crypto_pwm_clk?;
            match config {
                CryptoPwmClkConfig::Pll => pll_160m_root_source(clocks),
                CryptoPwmClkConfig::Cpu => cpu_clk_root_source(clocks),
            }
        }
        ...
        pub fn ble_lp_clk_config_frequency(clocks: &mut ClockTree, config: BleLpClkConfig) -> u32 {
            match config {
                ...
                BleLpClkConfig::RtcSlow => rtc_slow_clk_frequency(),
            }
        }
        ...
        impl I2sInstance {
            pub fn configure_tx_clk(self, clocks: &mut ClockTree, config: I2sClkConfig) {
                ...
                if clocks.i2s_tx_clk_refcount[self as usize] > 0 {
                    match config.sclk {
                        ...
                        I2sClkSclk::PllD2 => request_pll_d2(clocks),
                        I2sClkSclk::Pll160m => request_pll_160m(clocks),
                    }
                    self.configure_tx_clk_impl(clocks, old_config, config);
                    if let Some(old_config) = old_config {
                        match old_config.sclk {
                            I2sClkSclk::Xtal => release_xtal_clk(clocks),
                            I2sClkSclk::PllD2 => release_pll_d2(clocks),
                            I2sClkSclk::Pll160m => release_pll_160m(clocks),
                        }
                    }
                } else {
                    self.configure_tx_clk_impl(clocks, old_config, config);
            ...
            pub fn tx_clk_config_frequency(clocks: &mut ClockTree, config: I2sClkConfig) -> u32 {
                (((match config.sclk {
                    ...
                    I2sClkSclk::PllD2 => pll_d2_frequency(),
                    I2sClkSclk::Pll160m => pll_160m_frequency(),
                } as u64)
                    * (config.div_a() as u64))
                ...
                if clocks.spi_function_clock_refcount[self as usize] > 0 {
                    ...
                    if let Some(old_selector) = old_selector {
                        match old_selector {
                            ...
                            SpiFunctionClockConfig::Apb => release_apb_clk(clocks),
                        }
                    }
                } else {
                    self.configure_function_clock_impl(clocks, old_selector, new_selector);
...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        "IPC peripheral singleton"] IPC <= virtual() (unstable)));
        _for_each_inner_peripheral!((@ peri_type #[doc =
        ...
        "IPC peripheral singleton"] IPC <= virtual() (unstable)), (@ peri_type #[doc =
        "FROM_CPU_INTR0 peripheral singleton"] FROM_CPU_INTR0 <= virtual() (unstable)),
        ...
        (DMA_CH3(unstable)), (DMA_CH4(unstable)), (PCNT0_UNIT0(unstable)),
        ...
        (WIFI), (IPC(unstable)), (FROM_CPU_INTR2(unstable)),
        (FROM_CPU_INTR3(unstable)))); _for_each_inner_peripheral!((dma_eligible(SPI2,
        Spi2, 0, AhbGdmaChannel), (SPI3, Spi3, 1, AhbGdmaChannel), (UHCI0, Uhci0, 2,
        AhbGdmaChannel), (I2S0, I2s0, 3, AhbGdmaChannel), (I2S1, I2s1, 4,
        AhbGdmaChannel), (LCD_CAM, LcdCam, 5, AhbGdmaChannel), (AES, Aes, 6,
        AhbGdmaChannel), (SHA, Sha, 7, AhbGdmaChannel), (APB_SARADC, ApbSaradc, 8,
        AhbGdmaChannel), (RMT, Rmt, 9, AhbGdmaChannel)));
    };
}
...
macro_rules! for_each_analog_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_analog_function!((TOUCHn((TOUCH1, TOUCHn, 1), GPIO1), ((TOUCH2,
        TOUCHn, 2), GPIO2), ((TOUCH3, TOUCHn, 3), GPIO3), ((TOUCH4, TOUCHn, 4), GPIO4),
        ((TOUCH5, TOUCHn, 5), GPIO5), ((TOUCH6, TOUCHn, 6), GPIO6), ((TOUCH7, TOUCHn, 7),
        GPIO7), ((TOUCH8, TOUCHn, 8), GPIO8), ((TOUCH9, TOUCHn, 9), GPIO9), ((TOUCH10,
        TOUCHn, 10), GPIO10), ((TOUCH11, TOUCHn, 11), GPIO11), ((TOUCH12, TOUCHn, 12),
        GPIO12), ((TOUCH13, TOUCHn, 13), GPIO13), ((TOUCH14, TOUCHn, 14), GPIO14)));
...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_lp_function!((SAR_I2C_SCL_0, GPIO0, _3));
        _for_each_inner_lp_function!((LP_GPIO1, GPIO1, _0));
        _for_each_inner_lp_function!((SAR_I2C_SDA_0, GPIO1, _3));
        _for_each_inner_lp_function!((LP_GPIO2, GPIO2, _0));
        _for_each_inner_lp_function!((SAR_I2C_SCL_1, GPIO2, _3));
        _for_each_inner_lp_function!((LP_GPIO3, GPIO3, _0));
        _for_each_inner_lp_function!((SAR_I2C_SDA_1, GPIO3, _3));
        ...
        _for_each_inner_lp_function!((LP_GPIO8, GPIO8, _0));
        _for_each_inner_lp_function!((LP_GPIO9, GPIO9, _0));
        _for_each_inner_lp_function!((LP_GPIO10, GPIO10, _0));
        _for_each_inner_lp_function!((LP_GPIO11, GPIO11, _0));
        _for_each_inner_lp_function!((LP_GPIO12, GPIO12, _0));
        _for_each_inner_lp_function!((LP_GPIO13, GPIO13, _0));
        _for_each_inner_lp_function!((LP_GPIO14, GPIO14, _0));
        _for_each_inner_lp_function!((LP_GPIO15, GPIO15, _0));
        _for_each_inner_lp_function!((LP_GPIO16, GPIO16, _0));
        _for_each_inner_lp_function!((LP_GPIO17, GPIO17, _0));
        _for_each_inner_lp_function!((LP_GPIO18, GPIO18, _0));
        _for_each_inner_lp_function!((LP_GPIO19, GPIO19, _0));
        _for_each_inner_lp_function!((LP_GPIO20, GPIO20, _0));
        _for_each_inner_lp_function!((LP_GPIO21, GPIO21, _0));
        ...
        _for_each_inner_lp_function!(((LP_GPIO8, LP_GPIOn, 8), GPIO8, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO9, LP_GPIOn, 9), GPIO9, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO10, LP_GPIOn, 10), GPIO10, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO11, LP_GPIOn, 11), GPIO11, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO12, LP_GPIOn, 12), GPIO12, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO13, LP_GPIOn, 13), GPIO13, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO14, LP_GPIOn, 14), GPIO14, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO15, LP_GPIOn, 15), GPIO15, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO16, LP_GPIOn, 16), GPIO16, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO17, LP_GPIOn, 17), GPIO17, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO18, LP_GPIOn, 18), GPIO18, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO19, LP_GPIOn, 19), GPIO19, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO20, LP_GPIOn, 20), GPIO20, _0, () ()));
        _for_each_inner_lp_function!(((LP_GPIO21, LP_GPIOn, 21), GPIO21, _0, () ()));
        _for_each_inner_lp_function!(((SAR_I2C_SCL_0, SAR_I2C_SCL_n, 0), GPIO0, _3, ()
        ())); _for_each_inner_lp_function!(((SAR_I2C_SCL_1, SAR_I2C_SCL_n, 1), GPIO2, _3,
        () ())); _for_each_inner_lp_function!(((SAR_I2C_SDA_0, SAR_I2C_SDA_n, 0), GPIO1,
        _3, () ())); _for_each_inner_lp_function!(((SAR_I2C_SDA_1, SAR_I2C_SDA_n, 1),
        GPIO3, _3, () ())); _for_each_inner_lp_function!((all(LP_GPIO0, GPIO0, _0),
        (SAR_I2C_SCL_0, GPIO0, _3), (LP_GPIO1, GPIO1, _0), (SAR_I2C_SDA_0, GPIO1, _3),
        (LP_GPIO2, GPIO2, _0), (SAR_I2C_SCL_1, GPIO2, _3), (LP_GPIO3, GPIO3, _0),
        (SAR_I2C_SDA_1, GPIO3, _3), (LP_GPIO4, GPIO4, _0), (LP_GPIO5, GPIO5, _0),
        (LP_GPIO6, GPIO6, _0), (LP_GPIO7, GPIO7, _0), (LP_GPIO8, GPIO8, _0), (LP_GPIO9,
        GPIO9, _0), (LP_GPIO10, GPIO10, _0), (LP_GPIO11, GPIO11, _0), (LP_GPIO12, GPIO12,
        _0), (LP_GPIO13, GPIO13, _0), (LP_GPIO14, GPIO14, _0), (LP_GPIO15, GPIO15, _0),
        (LP_GPIO16, GPIO16, _0), (LP_GPIO17, GPIO17, _0), (LP_GPIO18, GPIO18, _0),
        (LP_GPIO19, GPIO19, _0), (LP_GPIO20, GPIO20, _0), (LP_GPIO21, GPIO21, _0)));
        ...
        () ()), ((LP_GPIO8, LP_GPIOn, 8), GPIO8, _0, () ()), ((LP_GPIO9, LP_GPIOn, 9),
        GPIO9, _0, () ()), ((LP_GPIO10, LP_GPIOn, 10), GPIO10, _0, () ()), ((LP_GPIO11,
        LP_GPIOn, 11), GPIO11, _0, () ()), ((LP_GPIO12, LP_GPIOn, 12), GPIO12, _0, ()
        ()), ((LP_GPIO13, LP_GPIOn, 13), GPIO13, _0, () ()), ((LP_GPIO14, LP_GPIOn, 14),
        GPIO14, _0, () ()), ((LP_GPIO15, LP_GPIOn, 15), GPIO15, _0, () ()), ((LP_GPIO16,
        LP_GPIOn, 16), GPIO16, _0, () ()), ((LP_GPIO17, LP_GPIOn, 17), GPIO17, _0, ()
        ()), ((LP_GPIO18, LP_GPIOn, 18), GPIO18, _0, () ()), ((LP_GPIO19, LP_GPIOn, 19),
        GPIO19, _0, () ()), ((LP_GPIO20, LP_GPIOn, 20), GPIO20, _0, () ()), ((LP_GPIO21,
        LP_GPIOn, 21), GPIO21, _0, () ())));
        _for_each_inner_lp_function!((SAR_I2C_SCL_n((SAR_I2C_SCL_0, SAR_I2C_SCL_n, 0),
        GPIO0, _3, () ()), ((SAR_I2C_SCL_1, SAR_I2C_SCL_n, 1), GPIO2, _3, () ())));
        _for_each_inner_lp_function!((SAR_I2C_SDA_n((SAR_I2C_SDA_0, SAR_I2C_SDA_n, 0),
        GPIO1, _3, () ()), ((SAR_I2C_SDA_1, SAR_I2C_SDA_n, 1), GPIO3, _3, () ())));
    };
}
...
macro_rules! for_each_iomux_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_iomux_function!((SPICLK_P_DIFF, GPIO47, _0));
        _for_each_inner_iomux_function!((SUBSPICLK_P_DIFF, GPIO47, _2));
        _for_each_inner_iomux_function!((SPICLK_N_DIFF, GPIO48, _0));
        _for_each_inner_iomux_function!((SUBSPICLK_N_DIFF, GPIO48, _2));
        ...
        _for_each_inner_iomux_function!(((SPIIO4, SPIIOn, 4), GPIO33, _4));
        _for_each_inner_iomux_function!(((SPIIO5, SPIIOn, 5), GPIO34, _4));
        _for_each_inner_iomux_function!(((SPIIO6, SPIIOn, 6), GPIO35, _4));
        _for_each_inner_iomux_function!(((SPIIO7, SPIIOn, 7), GPIO36, _4));
        ...
        _0), (FSPIHD, GPIO33, _2), (SUBSPIHD, GPIO33, _3), (SPIIO4, GPIO33, _4),
        (FSPICS0, GPIO34, _2), (SUBSPICS0, GPIO34, _3), (SPIIO5, GPIO34, _4), (FSPID,
        GPIO35, _2), (SUBSPID, GPIO35, _3), (SPIIO6, GPIO35, _4), (FSPICLK, GPIO36, _2),
        (SUBSPICLK, GPIO36, _3), (SPIIO7, GPIO36, _4), (FSPIQ, GPIO37, _2), (SUBSPIQ,
        GPIO37, _3), (SPIDQS, GPIO37, _4), (FSPIWP, GPIO38, _2), (SUBSPIWP, GPIO38, _3),
        (MTCK, GPIO39, _0), (CLK_OUT3, GPIO39, _2), (SUBSPICS1, GPIO39, _3), (MTDO,
        GPIO40, _0), (CLK_OUT2, GPIO40, _2), (MTDI, GPIO41, _0), (CLK_OUT1, GPIO41, _2),
        (MTMS, GPIO42, _0), (U0TXD, GPIO43, _0), (CLK_OUT1, GPIO43, _2), (U0RXD, GPIO44,
        _0), (CLK_OUT2, GPIO44, _2), (SPICLK_P_DIFF, GPIO47, _0), (SUBSPICLK_P_DIFF,
        GPIO47, _2), (SPICLK_N_DIFF, GPIO48, _0), (SUBSPICLK_N_DIFF, GPIO48, _2)));
        _for_each_inner_iomux_function!((SUBSPICSn((SUBSPICS1, SUBSPICSn, 1), GPIO8, _3),
        ((SUBSPICS0, SUBSPICSn, 0), GPIO10, _3), ((SUBSPICS0, SUBSPICSn, 0), GPIO34, _3),
        ((SUBSPICS1, SUBSPICSn, 1), GPIO39, _3)));
        _for_each_inner_iomux_function!((FSPIIOn((FSPIIO4, FSPIIOn, 4), GPIO10, _2),
        ((FSPIIO5, FSPIIOn, 5), GPIO11, _2), ((FSPIIO6, FSPIIOn, 6), GPIO12, _2),
        ((FSPIIO7, FSPIIOn, 7), GPIO13, _2)));
        _for_each_inner_iomux_function!((FSPICSn((FSPICS0, FSPICSn, 0), GPIO10, _4),
        ((FSPICS0, FSPICSn, 0), GPIO34, _2)));
        _for_each_inner_iomux_function!((CLK_OUTn((CLK_OUT3, CLK_OUTn, 3), GPIO18, _3),
        ((CLK_OUT2, CLK_OUTn, 2), GPIO19, _3), ((CLK_OUT1, CLK_OUTn, 1), GPIO20, _3),
        ((CLK_OUT3, CLK_OUTn, 3), GPIO39, _2), ((CLK_OUT2, CLK_OUTn, 2), GPIO40, _2),
