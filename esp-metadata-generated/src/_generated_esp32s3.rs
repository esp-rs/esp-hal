...
macro_rules! for_each_analog_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner!(((ADC2_CH6, ADCn_CHm, 2, 6), (GPIO17, 17)));
        _for_each_inner!((ADC2_CH7, GPIO18)); _for_each_inner!((ADC2_CH7, (GPIO18, 18)));
...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner!((SAR_I2C_SCL_0, GPIO0)); _for_each_inner!((SAR_I2C_SCL_0,
        (GPIO0, 0))); _for_each_inner!(((SAR_I2C_SCL_0, SAR_I2C_SCL_n, 0), GPIO0));
        _for_each_inner!(((SAR_I2C_SCL_0, SAR_I2C_SCL_n, 0), (GPIO0, 0)));
        ...
        _for_each_inner!((SAR_I2C_SDA_0, GPIO1)); _for_each_inner!((SAR_I2C_SDA_0,
        (GPIO1, 1))); _for_each_inner!(((SAR_I2C_SDA_0, SAR_I2C_SDA_n, 0), GPIO1));
        _for_each_inner!(((SAR_I2C_SDA_0, SAR_I2C_SDA_n, 0), (GPIO1, 1)));
        ...
        _for_each_inner!((SAR_I2C_SCL_1, GPIO2)); _for_each_inner!((SAR_I2C_SCL_1,
        (GPIO2, 2))); _for_each_inner!(((SAR_I2C_SCL_1, SAR_I2C_SCL_n, 1), GPIO2));
        _for_each_inner!(((SAR_I2C_SCL_1, SAR_I2C_SCL_n, 1), (GPIO2, 2)));
        ...
        _for_each_inner!((SAR_I2C_SDA_1, GPIO3)); _for_each_inner!((SAR_I2C_SDA_1,
        (GPIO3, 3))); _for_each_inner!(((SAR_I2C_SDA_1, SAR_I2C_SDA_n, 1), GPIO3));
        _for_each_inner!(((SAR_I2C_SDA_1, SAR_I2C_SDA_n, 1), (GPIO3, 3)));
        ...
        RTC_GPIOn, 0), GPIO0), ((RTC_GPIO0, RTC_GPIOn, 0), (GPIO0, 0)), (SAR_I2C_SCL_0,
        GPIO0), (SAR_I2C_SCL_0, (GPIO0, 0)), ((SAR_I2C_SCL_0, SAR_I2C_SCL_n, 0), GPIO0),
        ((SAR_I2C_SCL_0, SAR_I2C_SCL_n, 0), (GPIO0, 0)), (RTC_GPIO1, GPIO1), (RTC_GPIO1,
        (GPIO1, 1)), ((RTC_GPIO1, RTC_GPIOn, 1), GPIO1), ((RTC_GPIO1, RTC_GPIOn, 1),
        (GPIO1, 1)), (SAR_I2C_SDA_0, GPIO1), (SAR_I2C_SDA_0, (GPIO1, 1)),
        ((SAR_I2C_SDA_0, SAR_I2C_SDA_n, 0), GPIO1), ((SAR_I2C_SDA_0, SAR_I2C_SDA_n, 0),
        (GPIO1, 1)), (RTC_GPIO2, GPIO2), (RTC_GPIO2, (GPIO2, 2)), ((RTC_GPIO2, RTC_GPIOn,
        2), GPIO2), ((RTC_GPIO2, RTC_GPIOn, 2), (GPIO2, 2)), (SAR_I2C_SCL_1, GPIO2),
        (SAR_I2C_SCL_1, (GPIO2, 2)), ((SAR_I2C_SCL_1, SAR_I2C_SCL_n, 1), GPIO2),
        ((SAR_I2C_SCL_1, SAR_I2C_SCL_n, 1), (GPIO2, 2)), (RTC_GPIO3, GPIO3), (RTC_GPIO3,
        (GPIO3, 3)), ((RTC_GPIO3, RTC_GPIOn, 3), GPIO3), ((RTC_GPIO3, RTC_GPIOn, 3),
        (GPIO3, 3)), (SAR_I2C_SDA_1, GPIO3), (SAR_I2C_SDA_1, (GPIO3, 3)),
        ((SAR_I2C_SDA_1, SAR_I2C_SDA_n, 1), GPIO3), ((SAR_I2C_SDA_1, SAR_I2C_SDA_n, 1),
        (GPIO3, 3)), (RTC_GPIO4, GPIO4), (RTC_GPIO4, (GPIO4, 4)), ((RTC_GPIO4, RTC_GPIOn,
        4), GPIO4), ((RTC_GPIO4, RTC_GPIOn, 4), (GPIO4, 4)), (RTC_GPIO5, GPIO5),
        (RTC_GPIO5, (GPIO5, 5)), ((RTC_GPIO5, RTC_GPIOn, 5), GPIO5), ((RTC_GPIO5,
        RTC_GPIOn, 5), (GPIO5, 5)), (RTC_GPIO6, GPIO6), (RTC_GPIO6, (GPIO6, 6)),
        ((RTC_GPIO6, RTC_GPIOn, 6), GPIO6), ((RTC_GPIO6, RTC_GPIOn, 6), (GPIO6, 6)),
