...
macro_rules! for_each_wakeup_source {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_wakeup_source!((Gpio, 2)); _for_each_inner_wakeup_source!((Timer,
        3)); _for_each_inner_wakeup_source!((Wifi, 5));
        ...
        _for_each_inner_wakeup_source!((all(Ext1, 1), (Gpio, 2), (Timer, 3), (Wifi, 5),
        (Uart0, 6), (Uart1, 7), (Touch, 8), (Ulp, 9), (UlpRiscv, 11), (UlpRiscvTrap, 13),
        (Usb, 15)));
    };
}
#[macro_export]
