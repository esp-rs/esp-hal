...
macro_rules! for_each_analog_function {
    ($($pattern:tt => $code:tt;)*) => {
        macro_rules! _for_each_inner { $(($pattern) => $code;)* ($other : tt) => {} }
        _for_each_inner!((TOUCH1, GPIO1)); _for_each_inner!((TOUCH1, (GPIO1, 1)));
        _for_each_inner!(((TOUCH1, TOUCHn, 1), GPIO1)); _for_each_inner!(((TOUCH1,
        TOUCHn, 1), (GPIO1, 1))); _for_each_inner!((ADC1_CH0, GPIO1));
        _for_each_inner!((ADC1_CH0, (GPIO1, 1))); _for_each_inner!(((ADC1_CH0, ADCn_CHm,
        1, 0), GPIO1)); _for_each_inner!(((ADC1_CH0, ADCn_CHm, 1, 0), (GPIO1, 1)));
        _for_each_inner!((TOUCH2, GPIO2)); _for_each_inner!((TOUCH2, (GPIO2, 2)));
        _for_each_inner!(((TOUCH2, TOUCHn, 2), GPIO2)); _for_each_inner!(((TOUCH2,
        TOUCHn, 2), (GPIO2, 2))); _for_each_inner!((ADC1_CH1, GPIO2));
        _for_each_inner!((ADC1_CH1, (GPIO2, 2))); _for_each_inner!(((ADC1_CH1, ADCn_CHm,
        1, 1), GPIO2)); _for_each_inner!(((ADC1_CH1, ADCn_CHm, 1, 1), (GPIO2, 2)));
        _for_each_inner!((TOUCH3, GPIO3)); _for_each_inner!((TOUCH3, (GPIO3, 3)));
        _for_each_inner!(((TOUCH3, TOUCHn, 3), GPIO3)); _for_each_inner!(((TOUCH3,
        TOUCHn, 3), (GPIO3, 3))); _for_each_inner!((ADC1_CH2, GPIO3));
        _for_each_inner!((ADC1_CH2, (GPIO3, 3))); _for_each_inner!(((ADC1_CH2, ADCn_CHm,
        1, 2), GPIO3)); _for_each_inner!(((ADC1_CH2, ADCn_CHm, 1, 2), (GPIO3, 3)));
        _for_each_inner!((TOUCH4, GPIO4)); _for_each_inner!((TOUCH4, (GPIO4, 4)));
        _for_each_inner!(((TOUCH4, TOUCHn, 4), GPIO4)); _for_each_inner!(((TOUCH4,
        TOUCHn, 4), (GPIO4, 4))); _for_each_inner!((ADC1_CH3, GPIO4));
        _for_each_inner!((ADC1_CH3, (GPIO4, 4))); _for_each_inner!(((ADC1_CH3, ADCn_CHm,
        1, 3), GPIO4)); _for_each_inner!(((ADC1_CH3, ADCn_CHm, 1, 3), (GPIO4, 4)));
        _for_each_inner!((TOUCH5, GPIO5)); _for_each_inner!((TOUCH5, (GPIO5, 5)));
        _for_each_inner!(((TOUCH5, TOUCHn, 5), GPIO5)); _for_each_inner!(((TOUCH5,
        TOUCHn, 5), (GPIO5, 5))); _for_each_inner!((ADC1_CH4, GPIO5));
        _for_each_inner!((ADC1_CH4, (GPIO5, 5))); _for_each_inner!(((ADC1_CH4, ADCn_CHm,
        1, 4), GPIO5)); _for_each_inner!(((ADC1_CH4, ADCn_CHm, 1, 4), (GPIO5, 5)));
        _for_each_inner!((TOUCH6, GPIO6)); _for_each_inner!((TOUCH6, (GPIO6, 6)));
        _for_each_inner!(((TOUCH6, TOUCHn, 6), GPIO6)); _for_each_inner!(((TOUCH6,
        TOUCHn, 6), (GPIO6, 6))); _for_each_inner!((ADC1_CH5, GPIO6));
        _for_each_inner!((ADC1_CH5, (GPIO6, 6))); _for_each_inner!(((ADC1_CH5, ADCn_CHm,
        1, 5), GPIO6)); _for_each_inner!(((ADC1_CH5, ADCn_CHm, 1, 5), (GPIO6, 6)));
        _for_each_inner!((TOUCH7, GPIO7)); _for_each_inner!((TOUCH7, (GPIO7, 7)));
        _for_each_inner!(((TOUCH7, TOUCHn, 7), GPIO7)); _for_each_inner!(((TOUCH7,
        TOUCHn, 7), (GPIO7, 7))); _for_each_inner!((ADC1_CH6, GPIO7));
        _for_each_inner!((ADC1_CH6, (GPIO7, 7))); _for_each_inner!(((ADC1_CH6, ADCn_CHm,
        1, 6), GPIO7)); _for_each_inner!(((ADC1_CH6, ADCn_CHm, 1, 6), (GPIO7, 7)));
        _for_each_inner!((TOUCH8, GPIO8)); _for_each_inner!((TOUCH8, (GPIO8, 8)));
        _for_each_inner!(((TOUCH8, TOUCHn, 8), GPIO8)); _for_each_inner!(((TOUCH8,
        TOUCHn, 8), (GPIO8, 8))); _for_each_inner!((ADC1_CH7, GPIO8));
        _for_each_inner!((ADC1_CH7, (GPIO8, 8))); _for_each_inner!(((ADC1_CH7, ADCn_CHm,
        1, 7), GPIO8)); _for_each_inner!(((ADC1_CH7, ADCn_CHm, 1, 7), (GPIO8, 8)));
        _for_each_inner!((TOUCH9, GPIO9)); _for_each_inner!((TOUCH9, (GPIO9, 9)));
        _for_each_inner!(((TOUCH9, TOUCHn, 9), GPIO9)); _for_each_inner!(((TOUCH9,
        TOUCHn, 9), (GPIO9, 9))); _for_each_inner!((ADC1_CH8, GPIO9));
        _for_each_inner!((ADC1_CH8, (GPIO9, 9))); _for_each_inner!(((ADC1_CH8, ADCn_CHm,
        1, 8), GPIO9)); _for_each_inner!(((ADC1_CH8, ADCn_CHm, 1, 8), (GPIO9, 9)));
        _for_each_inner!((TOUCH10, GPIO10)); _for_each_inner!((TOUCH10, (GPIO10, 10)));
        _for_each_inner!(((TOUCH10, TOUCHn, 10), GPIO10)); _for_each_inner!(((TOUCH10,
        TOUCHn, 10), (GPIO10, 10))); _for_each_inner!((ADC1_CH9, GPIO10));
        _for_each_inner!((ADC1_CH9, (GPIO10, 10))); _for_each_inner!(((ADC1_CH9,
        ADCn_CHm, 1, 9), GPIO10)); _for_each_inner!(((ADC1_CH9, ADCn_CHm, 1, 9), (GPIO10,
        10))); _for_each_inner!((TOUCH11, GPIO11)); _for_each_inner!((TOUCH11, (GPIO11,
        11))); _for_each_inner!(((TOUCH11, TOUCHn, 11), GPIO11));
        _for_each_inner!(((TOUCH11, TOUCHn, 11), (GPIO11, 11)));
        _for_each_inner!((ADC2_CH0, GPIO11)); _for_each_inner!((ADC2_CH0, (GPIO11, 11)));
        _for_each_inner!(((ADC2_CH0, ADCn_CHm, 2, 0), GPIO11));
        _for_each_inner!(((ADC2_CH0, ADCn_CHm, 2, 0), (GPIO11, 11)));
        _for_each_inner!((TOUCH12, GPIO12)); _for_each_inner!((TOUCH12, (GPIO12, 12)));
        _for_each_inner!(((TOUCH12, TOUCHn, 12), GPIO12)); _for_each_inner!(((TOUCH12,
        TOUCHn, 12), (GPIO12, 12))); _for_each_inner!((ADC2_CH1, GPIO12));
        _for_each_inner!((ADC2_CH1, (GPIO12, 12))); _for_each_inner!(((ADC2_CH1,
        ADCn_CHm, 2, 1), GPIO12)); _for_each_inner!(((ADC2_CH1, ADCn_CHm, 2, 1), (GPIO12,
        12))); _for_each_inner!((TOUCH13, GPIO13)); _for_each_inner!((TOUCH13, (GPIO13,
        13))); _for_each_inner!(((TOUCH13, TOUCHn, 13), GPIO13));
        _for_each_inner!(((TOUCH13, TOUCHn, 13), (GPIO13, 13)));
        _for_each_inner!((ADC2_CH2, GPIO13)); _for_each_inner!((ADC2_CH2, (GPIO13, 13)));
        _for_each_inner!(((ADC2_CH2, ADCn_CHm, 2, 2), GPIO13));
        _for_each_inner!(((ADC2_CH2, ADCn_CHm, 2, 2), (GPIO13, 13)));
        _for_each_inner!((TOUCH14, GPIO14)); _for_each_inner!((TOUCH14, (GPIO14, 14)));
        _for_each_inner!(((TOUCH14, TOUCHn, 14), GPIO14)); _for_each_inner!(((TOUCH14,
        TOUCHn, 14), (GPIO14, 14))); _for_each_inner!((ADC2_CH3, GPIO14));
        ...
        _for_each_inner!((DAC_1, GPIO17)); _for_each_inner!((DAC_1, (GPIO17, 17)));
        _for_each_inner!(((DAC_1, DAC_n, 1), GPIO17)); _for_each_inner!(((DAC_1, DAC_n,
        1), (GPIO17, 17))); _for_each_inner!((ADC2_CH6, GPIO17));
        _for_each_inner!((ADC2_CH6, (GPIO17, 17))); _for_each_inner!(((ADC2_CH6,
        ADCn_CHm, 2, 6), GPIO17)); _for_each_inner!(((ADC2_CH6, ADCn_CHm, 2, 6), (GPIO17,
        17))); _for_each_inner!((DAC_2, GPIO18)); _for_each_inner!((DAC_2, (GPIO18,
        18))); _for_each_inner!(((DAC_2, DAC_n, 2), GPIO18)); _for_each_inner!(((DAC_2,
        DAC_n, 2), (GPIO18, 18))); _for_each_inner!((ADC2_CH7, GPIO18));
        _for_each_inner!((ADC2_CH7, (GPIO18, 18))); _for_each_inner!(((ADC2_CH7,
        ADCn_CHm, 2, 7), GPIO18)); _for_each_inner!(((ADC2_CH7, ADCn_CHm, 2, 7), (GPIO18,
        18))); _for_each_inner!((USB_DM, GPIO19)); _for_each_inner!((USB_DM, (GPIO19,
        19))); _for_each_inner!(((USB_DM, USB_DM), GPIO19)); _for_each_inner!(((USB_DM,
        USB_DM), (GPIO19, 19))); _for_each_inner!((ADC2_CH8, GPIO19));
        _for_each_inner!((ADC2_CH8, (GPIO19, 19))); _for_each_inner!(((ADC2_CH8,
        ADCn_CHm, 2, 8), GPIO19)); _for_each_inner!(((ADC2_CH8, ADCn_CHm, 2, 8), (GPIO19,
        19))); _for_each_inner!((USB_DP, GPIO20)); _for_each_inner!((USB_DP, (GPIO20,
        20))); _for_each_inner!(((USB_DP, USB_DP), GPIO20)); _for_each_inner!(((USB_DP,
        USB_DP), (GPIO20, 20))); _for_each_inner!((ADC2_CH9, GPIO20));
        _for_each_inner!((ADC2_CH9, (GPIO20, 20))); _for_each_inner!(((ADC2_CH9,
        ADCn_CHm, 2, 9), GPIO20)); _for_each_inner!(((ADC2_CH9, ADCn_CHm, 2, 9), (GPIO20,
        20))); _for_each_inner!((all(TOUCH1, GPIO1), (TOUCH1, (GPIO1, 1)), ((TOUCH1,
        TOUCHn, 1), GPIO1), ((TOUCH1, TOUCHn, 1), (GPIO1, 1)), (ADC1_CH0, GPIO1),
        (ADC1_CH0, (GPIO1, 1)), ((ADC1_CH0, ADCn_CHm, 1, 0), GPIO1), ((ADC1_CH0,
        ADCn_CHm, 1, 0), (GPIO1, 1)), (TOUCH2, GPIO2), (TOUCH2, (GPIO2, 2)), ((TOUCH2,
        TOUCHn, 2), GPIO2), ((TOUCH2, TOUCHn, 2), (GPIO2, 2)), (ADC1_CH1, GPIO2),
        (ADC1_CH1, (GPIO2, 2)), ((ADC1_CH1, ADCn_CHm, 1, 1), GPIO2), ((ADC1_CH1,
        ADCn_CHm, 1, 1), (GPIO2, 2)), (TOUCH3, GPIO3), (TOUCH3, (GPIO3, 3)), ((TOUCH3,
        TOUCHn, 3), GPIO3), ((TOUCH3, TOUCHn, 3), (GPIO3, 3)), (ADC1_CH2, GPIO3),
        (ADC1_CH2, (GPIO3, 3)), ((ADC1_CH2, ADCn_CHm, 1, 2), GPIO3), ((ADC1_CH2,
        ADCn_CHm, 1, 2), (GPIO3, 3)), (TOUCH4, GPIO4), (TOUCH4, (GPIO4, 4)), ((TOUCH4,
        TOUCHn, 4), GPIO4), ((TOUCH4, TOUCHn, 4), (GPIO4, 4)), (ADC1_CH3, GPIO4),
        (ADC1_CH3, (GPIO4, 4)), ((ADC1_CH3, ADCn_CHm, 1, 3), GPIO4), ((ADC1_CH3,
        ADCn_CHm, 1, 3), (GPIO4, 4)), (TOUCH5, GPIO5), (TOUCH5, (GPIO5, 5)), ((TOUCH5,
        TOUCHn, 5), GPIO5), ((TOUCH5, TOUCHn, 5), (GPIO5, 5)), (ADC1_CH4, GPIO5),
        (ADC1_CH4, (GPIO5, 5)), ((ADC1_CH4, ADCn_CHm, 1, 4), GPIO5), ((ADC1_CH4,
        ADCn_CHm, 1, 4), (GPIO5, 5)), (TOUCH6, GPIO6), (TOUCH6, (GPIO6, 6)), ((TOUCH6,
        TOUCHn, 6), GPIO6), ((TOUCH6, TOUCHn, 6), (GPIO6, 6)), (ADC1_CH5, GPIO6),
        (ADC1_CH5, (GPIO6, 6)), ((ADC1_CH5, ADCn_CHm, 1, 5), GPIO6), ((ADC1_CH5,
        ADCn_CHm, 1, 5), (GPIO6, 6)), (TOUCH7, GPIO7), (TOUCH7, (GPIO7, 7)), ((TOUCH7,
        TOUCHn, 7), GPIO7), ((TOUCH7, TOUCHn, 7), (GPIO7, 7)), (ADC1_CH6, GPIO7),
        (ADC1_CH6, (GPIO7, 7)), ((ADC1_CH6, ADCn_CHm, 1, 6), GPIO7), ((ADC1_CH6,
        ADCn_CHm, 1, 6), (GPIO7, 7)), (TOUCH8, GPIO8), (TOUCH8, (GPIO8, 8)), ((TOUCH8,
        TOUCHn, 8), GPIO8), ((TOUCH8, TOUCHn, 8), (GPIO8, 8)), (ADC1_CH7, GPIO8),
        (ADC1_CH7, (GPIO8, 8)), ((ADC1_CH7, ADCn_CHm, 1, 7), GPIO8), ((ADC1_CH7,
        ADCn_CHm, 1, 7), (GPIO8, 8)), (TOUCH9, GPIO9), (TOUCH9, (GPIO9, 9)), ((TOUCH9,
        TOUCHn, 9), GPIO9), ((TOUCH9, TOUCHn, 9), (GPIO9, 9)), (ADC1_CH8, GPIO9),
        (ADC1_CH8, (GPIO9, 9)), ((ADC1_CH8, ADCn_CHm, 1, 8), GPIO9), ((ADC1_CH8,
        ADCn_CHm, 1, 8), (GPIO9, 9)), (TOUCH10, GPIO10), (TOUCH10, (GPIO10, 10)),
        ((TOUCH10, TOUCHn, 10), GPIO10), ((TOUCH10, TOUCHn, 10), (GPIO10, 10)),
        (ADC1_CH9, GPIO10), (ADC1_CH9, (GPIO10, 10)), ((ADC1_CH9, ADCn_CHm, 1, 9),
        GPIO10), ((ADC1_CH9, ADCn_CHm, 1, 9), (GPIO10, 10)), (TOUCH11, GPIO11), (TOUCH11,
        (GPIO11, 11)), ((TOUCH11, TOUCHn, 11), GPIO11), ((TOUCH11, TOUCHn, 11), (GPIO11,
        11)), (ADC2_CH0, GPIO11), (ADC2_CH0, (GPIO11, 11)), ((ADC2_CH0, ADCn_CHm, 2, 0),
        GPIO11), ((ADC2_CH0, ADCn_CHm, 2, 0), (GPIO11, 11)), (TOUCH12, GPIO12), (TOUCH12,
        (GPIO12, 12)), ((TOUCH12, TOUCHn, 12), GPIO12), ((TOUCH12, TOUCHn, 12), (GPIO12,
        12)), (ADC2_CH1, GPIO12), (ADC2_CH1, (GPIO12, 12)), ((ADC2_CH1, ADCn_CHm, 2, 1),
        GPIO12), ((ADC2_CH1, ADCn_CHm, 2, 1), (GPIO12, 12)), (TOUCH13, GPIO13), (TOUCH13,
        (GPIO13, 13)), ((TOUCH13, TOUCHn, 13), GPIO13), ((TOUCH13, TOUCHn, 13), (GPIO13,
        13)), (ADC2_CH2, GPIO13), (ADC2_CH2, (GPIO13, 13)), ((ADC2_CH2, ADCn_CHm, 2, 2),
        GPIO13), ((ADC2_CH2, ADCn_CHm, 2, 2), (GPIO13, 13)), (TOUCH14, GPIO14), (TOUCH14,
        ...
        (GPIO16, 16)), (DAC_1, GPIO17), (DAC_1, (GPIO17, 17)), ((DAC_1, DAC_n, 1),
        GPIO17), ((DAC_1, DAC_n, 1), (GPIO17, 17)), (ADC2_CH6, GPIO17), (ADC2_CH6,
        (GPIO17, 17)), ((ADC2_CH6, ADCn_CHm, 2, 6), GPIO17), ((ADC2_CH6, ADCn_CHm, 2, 6),
        (GPIO17, 17)), (DAC_2, GPIO18), (DAC_2, (GPIO18, 18)), ((DAC_2, DAC_n, 2),
        GPIO18), ((DAC_2, DAC_n, 2), (GPIO18, 18)), (ADC2_CH7, GPIO18), (ADC2_CH7,
        (GPIO18, 18)), ((ADC2_CH7, ADCn_CHm, 2, 7), GPIO18), ((ADC2_CH7, ADCn_CHm, 2, 7),
        (GPIO18, 18)), (USB_DM, GPIO19), (USB_DM, (GPIO19, 19)), ((USB_DM, USB_DM),
        GPIO19), ((USB_DM, USB_DM), (GPIO19, 19)), (ADC2_CH8, GPIO19), (ADC2_CH8,
        (GPIO19, 19)), ((ADC2_CH8, ADCn_CHm, 2, 8), GPIO19), ((ADC2_CH8, ADCn_CHm, 2, 8),
        (GPIO19, 19)), (USB_DP, GPIO20), (USB_DP, (GPIO20, 20)), ((USB_DP, USB_DP),
        GPIO20), ((USB_DP, USB_DP), (GPIO20, 20)), (ADC2_CH9, GPIO20), (ADC2_CH9,
        (GPIO20, 20)), ((ADC2_CH9, ADCn_CHm, 2, 9), GPIO20), ((ADC2_CH9, ADCn_CHm, 2, 9),
        (GPIO20, 20))));
    };
}
...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        macro_rules! _for_each_inner { $(($pattern) => $code;)* ($other : tt) => {} }
        _for_each_inner!((RTC_GPIO0, GPIO0)); _for_each_inner!((RTC_GPIO0, (GPIO0, 0)));
        _for_each_inner!(((RTC_GPIO0, RTC_GPIOn, 0), GPIO0));
        _for_each_inner!(((RTC_GPIO0, RTC_GPIOn, 0), (GPIO0, 0)));
        _for_each_inner!((RTC_GPIO1, GPIO1)); _for_each_inner!((RTC_GPIO1, (GPIO1, 1)));
        _for_each_inner!(((RTC_GPIO1, RTC_GPIOn, 1), GPIO1));
        _for_each_inner!(((RTC_GPIO1, RTC_GPIOn, 1), (GPIO1, 1)));
        _for_each_inner!((RTC_GPIO2, GPIO2)); _for_each_inner!((RTC_GPIO2, (GPIO2, 2)));
        _for_each_inner!(((RTC_GPIO2, RTC_GPIOn, 2), GPIO2));
        _for_each_inner!(((RTC_GPIO2, RTC_GPIOn, 2), (GPIO2, 2)));
        _for_each_inner!((RTC_GPIO3, GPIO3)); _for_each_inner!((RTC_GPIO3, (GPIO3, 3)));
        _for_each_inner!(((RTC_GPIO3, RTC_GPIOn, 3), GPIO3));
        _for_each_inner!(((RTC_GPIO3, RTC_GPIOn, 3), (GPIO3, 3)));
        _for_each_inner!((RTC_GPIO4, GPIO4)); _for_each_inner!((RTC_GPIO4, (GPIO4, 4)));
        _for_each_inner!(((RTC_GPIO4, RTC_GPIOn, 4), GPIO4));
        _for_each_inner!(((RTC_GPIO4, RTC_GPIOn, 4), (GPIO4, 4)));
        _for_each_inner!((RTC_GPIO5, GPIO5)); _for_each_inner!((RTC_GPIO5, (GPIO5, 5)));
        _for_each_inner!(((RTC_GPIO5, RTC_GPIOn, 5), GPIO5));
        _for_each_inner!(((RTC_GPIO5, RTC_GPIOn, 5), (GPIO5, 5)));
        _for_each_inner!((RTC_GPIO6, GPIO6)); _for_each_inner!((RTC_GPIO6, (GPIO6, 6)));
        _for_each_inner!(((RTC_GPIO6, RTC_GPIOn, 6), GPIO6));
        _for_each_inner!(((RTC_GPIO6, RTC_GPIOn, 6), (GPIO6, 6)));
        _for_each_inner!((RTC_GPIO7, GPIO7)); _for_each_inner!((RTC_GPIO7, (GPIO7, 7)));
        _for_each_inner!(((RTC_GPIO7, RTC_GPIOn, 7), GPIO7));
        _for_each_inner!(((RTC_GPIO7, RTC_GPIOn, 7), (GPIO7, 7)));
        _for_each_inner!((RTC_GPIO8, GPIO8)); _for_each_inner!((RTC_GPIO8, (GPIO8, 8)));
        _for_each_inner!(((RTC_GPIO8, RTC_GPIOn, 8), GPIO8));
        _for_each_inner!(((RTC_GPIO8, RTC_GPIOn, 8), (GPIO8, 8)));
        _for_each_inner!((RTC_GPIO9, GPIO9)); _for_each_inner!((RTC_GPIO9, (GPIO9, 9)));
        _for_each_inner!(((RTC_GPIO9, RTC_GPIOn, 9), GPIO9));
        _for_each_inner!(((RTC_GPIO9, RTC_GPIOn, 9), (GPIO9, 9)));
        _for_each_inner!((RTC_GPIO10, GPIO10)); _for_each_inner!((RTC_GPIO10, (GPIO10,
        10))); _for_each_inner!(((RTC_GPIO10, RTC_GPIOn, 10), GPIO10));
        _for_each_inner!(((RTC_GPIO10, RTC_GPIOn, 10), (GPIO10, 10)));
        _for_each_inner!((RTC_GPIO11, GPIO11)); _for_each_inner!((RTC_GPIO11, (GPIO11,
        11))); _for_each_inner!(((RTC_GPIO11, RTC_GPIOn, 11), GPIO11));
        _for_each_inner!(((RTC_GPIO11, RTC_GPIOn, 11), (GPIO11, 11)));
        _for_each_inner!((RTC_GPIO12, GPIO12)); _for_each_inner!((RTC_GPIO12, (GPIO12,
        12))); _for_each_inner!(((RTC_GPIO12, RTC_GPIOn, 12), GPIO12));
        _for_each_inner!(((RTC_GPIO12, RTC_GPIOn, 12), (GPIO12, 12)));
        _for_each_inner!((RTC_GPIO13, GPIO13)); _for_each_inner!((RTC_GPIO13, (GPIO13,
        13))); _for_each_inner!(((RTC_GPIO13, RTC_GPIOn, 13), GPIO13));
        _for_each_inner!(((RTC_GPIO13, RTC_GPIOn, 13), (GPIO13, 13)));
        _for_each_inner!((RTC_GPIO14, GPIO14)); _for_each_inner!((RTC_GPIO14, (GPIO14,
        14))); _for_each_inner!(((RTC_GPIO14, RTC_GPIOn, 14), GPIO14));
        _for_each_inner!(((RTC_GPIO14, RTC_GPIOn, 14), (GPIO14, 14)));
        _for_each_inner!((RTC_GPIO15, GPIO15)); _for_each_inner!((RTC_GPIO15, (GPIO15,
        15))); _for_each_inner!(((RTC_GPIO15, RTC_GPIOn, 15), GPIO15));
        _for_each_inner!(((RTC_GPIO15, RTC_GPIOn, 15), (GPIO15, 15)));
        _for_each_inner!((RTC_GPIO16, GPIO16)); _for_each_inner!((RTC_GPIO16, (GPIO16,
        16))); _for_each_inner!(((RTC_GPIO16, RTC_GPIOn, 16), GPIO16));
        _for_each_inner!(((RTC_GPIO16, RTC_GPIOn, 16), (GPIO16, 16)));
        _for_each_inner!((RTC_GPIO17, GPIO17)); _for_each_inner!((RTC_GPIO17, (GPIO17,
        17))); _for_each_inner!(((RTC_GPIO17, RTC_GPIOn, 17), GPIO17));
        _for_each_inner!(((RTC_GPIO17, RTC_GPIOn, 17), (GPIO17, 17)));
        _for_each_inner!((RTC_GPIO18, GPIO18)); _for_each_inner!((RTC_GPIO18, (GPIO18,
        18))); _for_each_inner!(((RTC_GPIO18, RTC_GPIOn, 18), GPIO18));
        _for_each_inner!(((RTC_GPIO18, RTC_GPIOn, 18), (GPIO18, 18)));
        _for_each_inner!((RTC_GPIO19, GPIO19)); _for_each_inner!((RTC_GPIO19, (GPIO19,
        19))); _for_each_inner!(((RTC_GPIO19, RTC_GPIOn, 19), GPIO19));
        _for_each_inner!(((RTC_GPIO19, RTC_GPIOn, 19), (GPIO19, 19)));
        _for_each_inner!((RTC_GPIO20, GPIO20)); _for_each_inner!((RTC_GPIO20, (GPIO20,
        20))); _for_each_inner!(((RTC_GPIO20, RTC_GPIOn, 20), GPIO20));
        _for_each_inner!(((RTC_GPIO20, RTC_GPIOn, 20), (GPIO20, 20)));
        _for_each_inner!((RTC_GPIO21, GPIO21)); _for_each_inner!((RTC_GPIO21, (GPIO21,
        21))); _for_each_inner!(((RTC_GPIO21, RTC_GPIOn, 21), GPIO21));
        _for_each_inner!(((RTC_GPIO21, RTC_GPIOn, 21), (GPIO21, 21)));
        _for_each_inner!((all(RTC_GPIO0, GPIO0), (RTC_GPIO0, (GPIO0, 0)), ((RTC_GPIO0,
        RTC_GPIOn, 0), GPIO0), ((RTC_GPIO0, RTC_GPIOn, 0), (GPIO0, 0)), (RTC_GPIO1,
        GPIO1), (RTC_GPIO1, (GPIO1, 1)), ((RTC_GPIO1, RTC_GPIOn, 1), GPIO1), ((RTC_GPIO1,
        RTC_GPIOn, 1), (GPIO1, 1)), (RTC_GPIO2, GPIO2), (RTC_GPIO2, (GPIO2, 2)),
        ((RTC_GPIO2, RTC_GPIOn, 2), GPIO2), ((RTC_GPIO2, RTC_GPIOn, 2), (GPIO2, 2)),
        (RTC_GPIO3, GPIO3), (RTC_GPIO3, (GPIO3, 3)), ((RTC_GPIO3, RTC_GPIOn, 3), GPIO3),
        ((RTC_GPIO3, RTC_GPIOn, 3), (GPIO3, 3)), (RTC_GPIO4, GPIO4), (RTC_GPIO4, (GPIO4,
        4)), ((RTC_GPIO4, RTC_GPIOn, 4), GPIO4), ((RTC_GPIO4, RTC_GPIOn, 4), (GPIO4, 4)),
        (RTC_GPIO5, GPIO5), (RTC_GPIO5, (GPIO5, 5)), ((RTC_GPIO5, RTC_GPIOn, 5), GPIO5),
        ((RTC_GPIO5, RTC_GPIOn, 5), (GPIO5, 5)), (RTC_GPIO6, GPIO6), (RTC_GPIO6, (GPIO6,
        6)), ((RTC_GPIO6, RTC_GPIOn, 6), GPIO6), ((RTC_GPIO6, RTC_GPIOn, 6), (GPIO6, 6)),
        (RTC_GPIO7, GPIO7), (RTC_GPIO7, (GPIO7, 7)), ((RTC_GPIO7, RTC_GPIOn, 7), GPIO7),
        ((RTC_GPIO7, RTC_GPIOn, 7), (GPIO7, 7)), (RTC_GPIO8, GPIO8), (RTC_GPIO8, (GPIO8,
        8)), ((RTC_GPIO8, RTC_GPIOn, 8), GPIO8), ((RTC_GPIO8, RTC_GPIOn, 8), (GPIO8, 8)),
        (RTC_GPIO9, GPIO9), (RTC_GPIO9, (GPIO9, 9)), ((RTC_GPIO9, RTC_GPIOn, 9), GPIO9),
        ((RTC_GPIO9, RTC_GPIOn, 9), (GPIO9, 9)), (RTC_GPIO10, GPIO10), (RTC_GPIO10,
        (GPIO10, 10)), ((RTC_GPIO10, RTC_GPIOn, 10), GPIO10), ((RTC_GPIO10, RTC_GPIOn,
        10), (GPIO10, 10)), (RTC_GPIO11, GPIO11), (RTC_GPIO11, (GPIO11, 11)),
        ((RTC_GPIO11, RTC_GPIOn, 11), GPIO11), ((RTC_GPIO11, RTC_GPIOn, 11), (GPIO11,
        11)), (RTC_GPIO12, GPIO12), (RTC_GPIO12, (GPIO12, 12)), ((RTC_GPIO12, RTC_GPIOn,
        12), GPIO12), ((RTC_GPIO12, RTC_GPIOn, 12), (GPIO12, 12)), (RTC_GPIO13, GPIO13),
        (RTC_GPIO13, (GPIO13, 13)), ((RTC_GPIO13, RTC_GPIOn, 13), GPIO13), ((RTC_GPIO13,
        RTC_GPIOn, 13), (GPIO13, 13)), (RTC_GPIO14, GPIO14), (RTC_GPIO14, (GPIO14, 14)),
        ((RTC_GPIO14, RTC_GPIOn, 14), GPIO14), ((RTC_GPIO14, RTC_GPIOn, 14), (GPIO14,
        14)), (RTC_GPIO15, GPIO15), (RTC_GPIO15, (GPIO15, 15)), ((RTC_GPIO15, RTC_GPIOn,
        15), GPIO15), ((RTC_GPIO15, RTC_GPIOn, 15), (GPIO15, 15)), (RTC_GPIO16, GPIO16),
        (RTC_GPIO16, (GPIO16, 16)), ((RTC_GPIO16, RTC_GPIOn, 16), GPIO16), ((RTC_GPIO16,
        RTC_GPIOn, 16), (GPIO16, 16)), (RTC_GPIO17, GPIO17), (RTC_GPIO17, (GPIO17, 17)),
        ((RTC_GPIO17, RTC_GPIOn, 17), GPIO17), ((RTC_GPIO17, RTC_GPIOn, 17), (GPIO17,
        17)), (RTC_GPIO18, GPIO18), (RTC_GPIO18, (GPIO18, 18)), ((RTC_GPIO18, RTC_GPIOn,
        18), GPIO18), ((RTC_GPIO18, RTC_GPIOn, 18), (GPIO18, 18)), (RTC_GPIO19, GPIO19),
        (RTC_GPIO19, (GPIO19, 19)), ((RTC_GPIO19, RTC_GPIOn, 19), GPIO19), ((RTC_GPIO19,
        RTC_GPIOn, 19), (GPIO19, 19)), (RTC_GPIO20, GPIO20), (RTC_GPIO20, (GPIO20, 20)),
        ((RTC_GPIO20, RTC_GPIOn, 20), GPIO20), ((RTC_GPIO20, RTC_GPIOn, 20), (GPIO20,
        20)), (RTC_GPIO21, GPIO21), (RTC_GPIO21, (GPIO21, 21)), ((RTC_GPIO21, RTC_GPIOn,
        21), GPIO21), ((RTC_GPIO21, RTC_GPIOn, 21), (GPIO21, 21))));
    };
}
#[macro_export]
