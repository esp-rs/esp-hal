...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        peri_type GPIO20 <= virtual())); _for_each_inner!((@ peri_type GPIO21 <=
        ...
        (@ peri_type GPIO18 <= virtual()), (@ peri_type GPIO19 <= virtual()), (@
        peri_type GPIO20 <= virtual()), (@ peri_type GPIO21 <= virtual()), (@ peri_type
