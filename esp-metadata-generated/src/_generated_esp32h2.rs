...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        "GPIO8 peripheral singleton"] GPIO8 <= virtual())); _for_each_inner!((@ peri_type
        #[doc = "GPIO9 peripheral singleton"] GPIO9 <= virtual())); _for_each_inner!((@
        ...
        "Please check the documentation for your specific device."] #[doc =
        "Using a reserved pin may result in unexpected behavior."] #[doc = "</section>"]
        GPIO7 <= virtual()), (@ peri_type #[doc = "GPIO8 peripheral singleton"] GPIO8 <=
        ...
        virtual()), (@ peri_type #[doc = "GPIO24 peripheral singleton"] GPIO24 <=
