...
macro_rules! define_clock_tree_types {
    () => {
        ...
        : u32, cpu_clk_refcount : u32, apb_clk_refcount : u32, lp_fast_clk_refcount :
        u32, lp_slow_clk_refcount : u32, mcpwm0_function_clock_refcount : u32,
        ...
        request_pll_f96m_clk(clocks : & mut ClockTree) {
