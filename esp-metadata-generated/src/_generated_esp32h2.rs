        ...
        impl I2sInstance {
            pub fn configure_tx_clock(
                ...
                if clocks.i2s_tx_clock_refcount[self as usize] > 0 {
                    match new_selector {
                        ...
                        I2sTxClockConfig::PllF96m => request_pll_f96m_clk(clocks),
                        I2sTxClockConfig::PllF64m => request_pll_f64m_clk(clocks),
                    }
                    self.configure_tx_clock_impl(clocks, old_selector, new_selector);
                    if let Some(old_selector) = old_selector {
                        match old_selector {
                            I2sTxClockConfig::XtalClk => release_xtal_clk(clocks),
                            I2sTxClockConfig::PllF96m => release_pll_f96m_clk(clocks),
                            I2sTxClockConfig::PllF64m => release_pll_f64m_clk(clocks),
                        }
                    }
                } else {
                    self.configure_tx_clock_impl(clocks, old_selector, new_selector);
            ...
            pub fn tx_clock_config_frequency(
                ...
                match config {
                    ...
                    I2sTxClockConfig::PllF96m => pll_f96m_clk_frequency(),
                    I2sTxClockConfig::PllF64m => pll_f64m_clk_frequency(),
                }
            }
            ...
            pub fn configure_rx_clock(
                ...
                if clocks.i2s_rx_clock_refcount[self as usize] > 0 {
                    match new_selector {
                        ...
                        I2sRxClockConfig::PllF96m => request_pll_f96m_clk(clocks),
                        I2sRxClockConfig::PllF64m => request_pll_f64m_clk(clocks),
                    }
                    self.configure_rx_clock_impl(clocks, old_selector, new_selector);
                    if let Some(old_selector) = old_selector {
                        match old_selector {
                            I2sRxClockConfig::XtalClk => release_xtal_clk(clocks),
                            I2sRxClockConfig::PllF96m => release_pll_f96m_clk(clocks),
                            I2sRxClockConfig::PllF64m => release_pll_f64m_clk(clocks),
                        }
                    }
                } else {
                    self.configure_rx_clock_impl(clocks, old_selector, new_selector);
            ...
            pub fn rx_clock_config_frequency(
                ...
                match config {
                    ...
                    I2sRxClockConfig::PllF96m => pll_f96m_clk_frequency(),
                    I2sRxClockConfig::PllF64m => pll_f64m_clk_frequency(),
                }
            }
