    ...
    () => {
        ...
        fn refresh_xtal_clk_downstream(clocks: &mut ClockTree) {
            ...
            for child_instance in [I2sInstance::I2s0] {
                refresh_i2s_tx_clk_downstream(clocks, child_instance);
                refresh_i2s_rx_clk_downstream(clocks, child_instance);
            }
...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        LP_WDT() (unstable)), (@ peri_type #[doc = "MODEM_LPCON peripheral singleton"]
        MODEM_LPCON <= MODEM_LPCON() (unstable)), (@ peri_type #[doc =
        "MODEM_SYSCON peripheral singleton"] MODEM_SYSCON <= MODEM_SYSCON() (unstable)),
        ...
        (DMA(unstable)), (ECC(unstable)), (GPIO(unstable)), (GPIO_DEDICATED(unstable)),
        (GPIO_SD(unstable)), (HP_APM(unstable)), (HP_SYS(unstable)),
        (I2C_ANA_MST(unstable)), (I2S0(unstable)), (I2C0), (I2C1),
        (INTERRUPT_CORE0(unstable)), (INTERRUPT_CORE1(unstable)), (CLINT(unstable)),
        (CLINT_OTHER_CORE(unstable)), (INTPRI(unstable)), (IO_MUX(unstable)),
        ...
        (USB_DEVICE(unstable)), (CPU_CTRL(unstable)), (IPC(unstable)), (FLASH(unstable)),
        (FROM_CPU_INTR0(unstable)), (FROM_CPU_INTR1(unstable)),
        (FROM_CPU_INTR2(unstable)), (FROM_CPU_INTR3(unstable))));
        _for_each_inner_peripheral!((dma_eligible(SPI3, Spi3, 0, AhbGdmaChannel), (SPI2,
        Spi2, 1, AhbGdmaChannel), (UHCI0, Uhci0, 2, AhbGdmaChannel), (I2S0, I2s0, 3,
        AhbGdmaChannel), (AES, Aes, 4, AhbGdmaChannel), (SHA, Sha, 7, AhbGdmaChannel),
        (PARL_IO, ParlIo, 9, AhbGdmaChannel)));
    };
}
