...
macro_rules! property {
    ...
    ("clock_tree.spi.function_clock") => {
        ...
        ::soc::clocks::SpiFunctionClockConfig::PllF48m, crate
        ::soc::clocks::SpiFunctionClockConfig::RcFast]
    };
    ("clock_tree.i2s.tx_clk.sclk") => {
        [crate ::soc::clocks::I2sClkSclk::Xtal, crate ::soc::clocks::I2sClkSclk::PllF96m,
        crate ::soc::clocks::I2sClkSclk::XtalX2]
    };
...
macro_rules! for_each_dma_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        interrupt_out = DMA_OUT_CH0, compatible = [SPI3, SPI2, UHCI0, I2S0, AES, SHA,
        PARL_IO])); _for_each_inner_dma_channel!(("AHB_GDMA", DMA_CH1, 1, interrupt_in =
        DMA_IN_CH1, interrupt_out = DMA_OUT_CH1, compatible = [SPI3, SPI2, UHCI0, I2S0,
        AES, SHA, PARL_IO])); _for_each_inner_dma_channel!(("AHB_GDMA", DMA_CH2, 2,
        interrupt_in = DMA_IN_CH2, interrupt_out = DMA_OUT_CH2, compatible = [SPI3, SPI2,
        UHCI0, I2S0, AES, SHA, PARL_IO])); _for_each_inner_dma_channel!(("AHB_GDMA",
        DMA_CH3, 3, interrupt_in = DMA_IN_CH3, interrupt_out = DMA_OUT_CH3, compatible =
        [SPI3, SPI2, UHCI0, I2S0, AES, SHA, PARL_IO]));
        _for_each_inner_dma_channel!(("AHB_GDMA", DMA_CH4, 4, interrupt_in = DMA_IN_CH4,
        interrupt_out = DMA_OUT_CH4, compatible = [SPI3, SPI2, UHCI0, I2S0, AES, SHA,
        PARL_IO])); _for_each_inner_dma_channel!((names("AHB_GDMA", DMA_CH0),
        ("AHB_GDMA", DMA_CH1), ("AHB_GDMA", DMA_CH2), ("AHB_GDMA", DMA_CH3), ("AHB_GDMA",
        DMA_CH4))); _for_each_inner_dma_channel!((separate_any_type("AHB_GDMA",
        ...
        DMA_IN_CH0, interrupt_out = DMA_OUT_CH0, compatible = [SPI3, SPI2, UHCI0, I2S0,
        AES, SHA, PARL_IO]), ("AHB_GDMA", DMA_CH1, 1, interrupt_in = DMA_IN_CH1,
        interrupt_out = DMA_OUT_CH1, compatible = [SPI3, SPI2, UHCI0, I2S0, AES, SHA,
        PARL_IO]), ("AHB_GDMA", DMA_CH2, 2, interrupt_in = DMA_IN_CH2, interrupt_out =
        DMA_OUT_CH2, compatible = [SPI3, SPI2, UHCI0, I2S0, AES, SHA, PARL_IO]),
        ("AHB_GDMA", DMA_CH3, 3, interrupt_in = DMA_IN_CH3, interrupt_out = DMA_OUT_CH3,
        compatible = [SPI3, SPI2, UHCI0, I2S0, AES, SHA, PARL_IO]), ("AHB_GDMA", DMA_CH4,
        4, interrupt_in = DMA_IN_CH4, interrupt_out = DMA_OUT_CH4, compatible = [SPI3,
        SPI2, UHCI0, I2S0, AES, SHA, PARL_IO])));
...
macro_rules! for_each_dma_channel_peri_pair {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        DMA_CH0, SPI3)); _for_each_inner_dma_channel_peri_pair!(("AHB_GDMA", DMA_CH0,
        SPI2)); _for_each_inner_dma_channel_peri_pair!(("AHB_GDMA", DMA_CH0, UHCI0));
        ...
        _for_each_inner_dma_channel_peri_pair!(("AHB_GDMA", DMA_CH3, PARL_IO));
        ...
        _for_each_inner_dma_channel_peri_pair!(("AHB_GDMA", DMA_CH4, PARL_IO));
        _for_each_inner_dma_channel_peri_pair!(("AHB_GDMA", any_channel = AhbGdmaChannel,
        SPI3)); _for_each_inner_dma_channel_peri_pair!(("AHB_GDMA", any_channel =
        ...
        SPI3), ("AHB_GDMA", DMA_CH0, SPI2), ("AHB_GDMA", DMA_CH0, UHCI0), ("AHB_GDMA",
        DMA_CH0, I2S0), ("AHB_GDMA", DMA_CH0, AES), ("AHB_GDMA", DMA_CH0, SHA),
        ("AHB_GDMA", DMA_CH0, PARL_IO), ("AHB_GDMA", DMA_CH1, SPI3), ("AHB_GDMA",
        DMA_CH1, SPI2), ("AHB_GDMA", DMA_CH1, UHCI0), ("AHB_GDMA", DMA_CH1, I2S0),
        ("AHB_GDMA", DMA_CH1, AES), ("AHB_GDMA", DMA_CH1, SHA), ("AHB_GDMA", DMA_CH1,
        PARL_IO), ("AHB_GDMA", DMA_CH2, SPI3), ("AHB_GDMA", DMA_CH2, SPI2), ("AHB_GDMA",
        DMA_CH2, UHCI0), ("AHB_GDMA", DMA_CH2, I2S0), ("AHB_GDMA", DMA_CH2, AES),
        ("AHB_GDMA", DMA_CH2, SHA), ("AHB_GDMA", DMA_CH2, PARL_IO), ("AHB_GDMA", DMA_CH3,
        SPI3), ("AHB_GDMA", DMA_CH3, SPI2), ("AHB_GDMA", DMA_CH3, UHCI0), ("AHB_GDMA",
        DMA_CH3, I2S0), ("AHB_GDMA", DMA_CH3, AES), ("AHB_GDMA", DMA_CH3, SHA),
        ("AHB_GDMA", DMA_CH3, PARL_IO), ("AHB_GDMA", DMA_CH4, SPI3), ("AHB_GDMA",
        DMA_CH4, SPI2), ("AHB_GDMA", DMA_CH4, UHCI0), ("AHB_GDMA", DMA_CH4, I2S0),
        ("AHB_GDMA", DMA_CH4, AES), ("AHB_GDMA", DMA_CH4, SHA), ("AHB_GDMA", DMA_CH4,
        PARL_IO))); _for_each_inner_dma_channel_peri_pair!((any_channels("AHB_GDMA",
        any_channel = AhbGdmaChannel, SPI3), ("AHB_GDMA", any_channel = AhbGdmaChannel,
        SPI2), ("AHB_GDMA", any_channel = AhbGdmaChannel, UHCI0), ("AHB_GDMA",
        any_channel = AhbGdmaChannel, I2S0), ("AHB_GDMA", any_channel = AhbGdmaChannel,
        AES), ("AHB_GDMA", any_channel = AhbGdmaChannel, SHA), ("AHB_GDMA", any_channel =
...
macro_rules! for_each_mem2mem_channel {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        AhbGdmaChannel, DMA_CH0, 10)); _for_each_inner_mem2mem_channel!(("AHB_GDMA",
        AhbGdma, AhbGdmaChannel, DMA_CH1, 11));
        _for_each_inner_mem2mem_channel!(("AHB_GDMA", AhbGdma, AhbGdmaChannel, DMA_CH2,
        12)); _for_each_inner_mem2mem_channel!(("AHB_GDMA", AhbGdma, AhbGdmaChannel,
        DMA_CH3, 13)); _for_each_inner_mem2mem_channel!(("AHB_GDMA", AhbGdma,
        AhbGdmaChannel, DMA_CH4, 14)); _for_each_inner_mem2mem_channel!(("AHB_GDMA",
        AhbGdma, AhbGdmaChannel, 0, 10, 1, 11, 2, 12, 3, 13, 4, 14));
        ...
        DMA_CH0, 10), ("AHB_GDMA", AhbGdma, AhbGdmaChannel, DMA_CH1, 11), ("AHB_GDMA",
        AhbGdma, AhbGdmaChannel, DMA_CH2, 12), ("AHB_GDMA", AhbGdma, AhbGdmaChannel,
        DMA_CH3, 13), ("AHB_GDMA", AhbGdma, AhbGdmaChannel, DMA_CH4, 14)));
...
macro_rules! define_clock_tree_types {
    () => {
        ...
        pub struct ClockTree {
            ...
            i2s_rx_clk: [Option<I2sClkConfig>; 1],
            i2s_mclk_out: [Option<I2sMclkOutConfig>; 1],
        ...
        static TIMG_CALIBRATION_CLOCK_FREQ_CACHE: ::core::sync::atomic::AtomicU32 =
            ::core::sync::atomic::AtomicU32::new(0);
        static I2S_TX_CLK_FREQ_CACHE: [::core::sync::atomic::AtomicU32; 1] =
            [const { ::core::sync::atomic::AtomicU32::new(0) }; 1];
        static I2S_RX_CLK_FREQ_CACHE: [::core::sync::atomic::AtomicU32; 1] =
            [const { ::core::sync::atomic::AtomicU32::new(0) }; 1];
        ...
        /// Returns the clock source that `XTAL_X2_CLK` currently runs on.
        pub fn xtal_x2_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            xtal_clk_root_source(clocks)
        }
        ...
        /// Returns the clock source that `RC_SLOW_D4_CLK` currently runs on.
        pub fn rc_slow_d4_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            rc_slow_clk_root_source(clocks)
        }
        ...
        pub fn hp_root_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            ...
            match config {
                ...
                HpRootClkConfig::XtalX2 => xtal_x2_clk_root_source(clocks),
                HpRootClkConfig::Pll => pll_f96m_clk_root_source(clocks),
            }
        }
        ...
        pub fn lp_slow_clk_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            ...
            match config {
                ...
                LpSlowClkConfig::RcSlow => rc_slow_d4_clk_root_source(clocks),
        ...
        pub fn timg_calibration_clock_root_source(clocks: &mut ClockTree) -> Option<ClockSource> {
            ...
            match config {
                TimgCalibrationClockConfig::RcSlowClk => rc_slow_d4_clk_root_source(clocks),
        ...
        pub fn request_xtal_x2_clk(clocks: &mut ClockTree) {
            ...
            if increment_reference_count(&mut clocks.xtal_x2_clk_refcount) {
        ...
        pub fn release_xtal_x2_clk(clocks: &mut ClockTree) {
            ...
            if decrement_reference_count(&mut clocks.xtal_x2_clk_refcount) {
        ...
        pub fn set_rc_slow_clk_frequency(clocks: &mut ClockTree, frequency: u32) {
            if !(300000..=900000).contains(&frequency) {
                warn!(
        ...
        pub fn request_rc_slow_d4_clk(clocks: &mut ClockTree) {
            ...
            if increment_reference_count(&mut clocks.rc_slow_d4_clk_refcount) {
        ...
        pub fn release_rc_slow_d4_clk(clocks: &mut ClockTree) {
            ...
            if decrement_reference_count(&mut clocks.rc_slow_d4_clk_refcount) {
        ...
        pub fn configure_timg_calibration_clock(
            ...
            if clocks.timg_calibration_clock_refcount > 0 {
                match new_selector {
                    TimgCalibrationClockConfig::RcSlowClk => request_rc_slow_d4_clk(clocks),
                ...
                if let Some(old_selector) = old_selector {
                    match old_selector {
                        TimgCalibrationClockConfig::RcSlowClk => release_rc_slow_d4_clk(clocks),
        ...
        pub fn timg_calibration_clock_config_frequency(
            ...
            match config {
                TimgCalibrationClockConfig::RcSlowClk => rc_slow_d4_clk_frequency(),
        ...
        impl I2sInstance {
            pub fn configure_tx_clk(self, clocks: &mut ClockTree, config: I2sClkConfig) {
                ...
                if clocks.i2s_tx_clk_refcount[self as usize] > 0 {
                    match config.sclk {
                        I2sClkSclk::Xtal => request_xtal_clk(clocks),
                        I2sClkSclk::PllF96m => request_pll_f96m_clk(clocks),
                        I2sClkSclk::XtalX2 => request_xtal_x2_clk(clocks),
                    }
                    self.configure_tx_clk_impl(clocks, old_config, config);
                    if let Some(old_config) = old_config {
                        match old_config.sclk {
                            I2sClkSclk::Xtal => release_xtal_clk(clocks),
                            I2sClkSclk::PllF96m => release_pll_f96m_clk(clocks),
                            I2sClkSclk::XtalX2 => release_xtal_x2_clk(clocks),
                        }
                    }
                } else {
                    self.configure_tx_clk_impl(clocks, old_config, config);
            ...
            pub fn tx_clk_config_frequency(clocks: &mut ClockTree, config: I2sClkConfig) -> u32 {
                (((match config.sclk {
                    ...
                    I2sClkSclk::PllF96m => pll_f96m_clk_frequency(),
                    I2sClkSclk::XtalX2 => xtal_x2_clk_frequency(),
                } as u64)
                    * (config.div_a() as u64))
            ...
            pub fn configure_rx_clk(self, clocks: &mut ClockTree, config: I2sClkConfig) {
                ...
                if clocks.i2s_rx_clk_refcount[self as usize] > 0 {
                    match config.sclk {
                        I2sClkSclk::Xtal => request_xtal_clk(clocks),
                        I2sClkSclk::PllF96m => request_pll_f96m_clk(clocks),
                        I2sClkSclk::XtalX2 => request_xtal_x2_clk(clocks),
                ...
                if clocks.spi_function_clock_refcount[self as usize] > 0 {
                    ...
                    if let Some(old_selector) = old_selector {
                        match old_selector {
                            ...
                            SpiFunctionClockConfig::PllF48m => release_pll_f48m_clk(clocks),
...
macro_rules! for_each_i2s {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        I2SO_BCK, I2SO_WS, I2SI_BCK, I2SI_WS, [I2SO_SD, I2SO_SD1], [I2SI_SD], true, true,
        true, false)); _for_each_inner_i2s!((names(I2S0)));
        _for_each_inner_i2s!((all(I2S0, I2s0, I2S_MCLK, I2SO_BCK, I2SO_WS, I2SI_BCK,
        I2SI_WS, [I2SO_SD, I2SO_SD1], [I2SI_SD], true, true, true, false)));
    };
}
...
macro_rules! for_each_spi_master {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_spi_master!((SPI3, Spi3, FSPI3CLK[FSPI3CS0, FSPI3CS1, FSPI3CS2]
        [FSPI3D, FSPI3Q, FSPI3WP, FSPI3HD], true));
        _for_each_inner_spi_master!((names(SPI2), (SPI3)));
        _for_each_inner_spi_master!((all(SPI2, Spi2, FSPICLK[FSPICS0, FSPICS1, FSPICS2,
        FSPICS3, FSPICS4, FSPICS5] [FSPID, FSPIQ, FSPIWP, FSPIHD], true), (SPI3, Spi3,
        FSPI3CLK[FSPI3CS0, FSPI3CS1, FSPI3CS2] [FSPI3D, FSPI3Q, FSPI3WP, FSPI3HD],
        true)));
    };
}
...
macro_rules! for_each_spi_slave {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_spi_slave!((SPI3, Spi3, FSPI3CLK, FSPI3D, FSPI3Q, FSPI3CS0));
        _for_each_inner_spi_slave!((names(SPI2), (SPI3)));
        _for_each_inner_spi_slave!((all(SPI2, Spi2, FSPICLK, FSPID, FSPIQ, FSPICS0),
        (SPI3, Spi3, FSPI3CLK, FSPI3D, FSPI3Q, FSPI3CS0)));
    };
}
...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        "APB_SARADC peripheral singleton"] APB_SARADC <= APB_SARADC(APB_ADC : {
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        "ASRC peripheral singleton"] ASRC <= ASRC(ASRC_CHNL0 : { bind_chnl0_interrupt,
        enable_chnl0_interrupt, disable_chnl0_interrupt }, ASRC_CHNL1 : {
        bind_chnl1_interrupt, enable_chnl1_interrupt, disable_chnl1_interrupt })
        (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        "BUS_MONITOR peripheral singleton"] BUS_MONITOR <= BUS_MONITOR(BUS_MONITOR : {
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        "CACHE peripheral singleton"] CACHE <= CACHE(CACHE : { bind_peri_interrupt,
        ...
        <= HUK(HUK : { bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt
        }) (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        ...
        "KEYMNG peripheral singleton"] KEYMNG <= KEYMNG(KM : { bind_peri_interrupt,
        enable_peri_interrupt, disable_peri_interrupt }) (unstable)));
        ...
        "MCPWM0 peripheral singleton"] MCPWM0 <= MCPWM0(MCPWM0 : { bind_peri_interrupt,
        enable_peri_interrupt, disable_peri_interrupt }) (unstable)));
        _for_each_inner_peripheral!((@ peri_type #[doc = "MCPWM1 peripheral singleton"]
        MCPWM1 <= MCPWM1(MCPWM1 : { bind_peri_interrupt, enable_peri_interrupt,
        disable_peri_interrupt }) (unstable))); _for_each_inner_peripheral!((@ peri_type
        ...
        #[doc = "PAU peripheral singleton"] PAU <= PAU(PAU : { bind_peri_interrupt,
        enable_peri_interrupt, disable_peri_interrupt }) (unstable)));
        ...
        <= PMU(PMU : { bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt
        }) (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        "PVT peripheral singleton"] PVT <= PVT() (unstable)));
        ...
        "TOUCH peripheral singleton"] TOUCH <= TOUCH(TOUCH : { bind_peri_interrupt,
        enable_peri_interrupt, disable_peri_interrupt }) (unstable)));
        _for_each_inner_peripheral!((@ peri_type #[doc =
        "TOUCH_AON peripheral singleton"] TOUCH_AON <= TOUCH_AON() (unstable)));
        ...
        enable_timer_interrupt, disable_timer_interrupt }) (unstable)));
        ...
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        "USB_FS peripheral singleton"] USB_FS <= USB0(USB_OTG11 : { bind_peri_interrupt,
        enable_peri_interrupt, disable_peri_interrupt }) (unstable)));
        ...
        #[doc = "ZERO_DET peripheral singleton"] ZERO_DET <= ZERO_DET(ZERO_DET : {
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        ...
        #[doc = "IPC peripheral singleton"] IPC <= virtual() (unstable)));
        ...
        _for_each_inner_peripheral!((ASRC(unstable)));
        _for_each_inner_peripheral!((BUS_MONITOR(unstable)));
        ...
        _for_each_inner_peripheral!((CLINT_OTHER_CORE(unstable)));
        ...
        _for_each_inner_peripheral!((PVT(unstable)));
        ...
        _for_each_inner_peripheral!((TOUCH_AON(unstable)));
        ...
        _for_each_inner_peripheral!((ZERO_DET(unstable)));
        ...
        _for_each_inner_peripheral!((SPI3, Spi3, 0, AhbGdmaChannel));
        ...
        = "APB_SARADC peripheral singleton"] APB_SARADC <= APB_SARADC(APB_ADC : {
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable)), (@ peri_type #[doc = "ASRC peripheral singleton"] ASRC <=
        ASRC(ASRC_CHNL0 : { bind_chnl0_interrupt, enable_chnl0_interrupt,
        disable_chnl0_interrupt }, ASRC_CHNL1 : { bind_chnl1_interrupt,
        enable_chnl1_interrupt, disable_chnl1_interrupt }) (unstable)), (@ peri_type
        #[doc = "BUS_MONITOR peripheral singleton"] BUS_MONITOR <=
        BUS_MONITOR(BUS_MONITOR : { bind_peri_interrupt, enable_peri_interrupt,
        ...
        CPU_APM() (unstable)), (@ peri_type #[doc = "DMA peripheral singleton"] DMA <=
        DMA() (unstable)), (@ peri_type #[doc = "ECC peripheral singleton"] ECC <=
        ...
        <= I2C_ANA_MST() (unstable)), (@ peri_type #[doc = "I2S0 peripheral singleton"]
        I2S0 <= I2S0(I2S : { bind_peri_interrupt, enable_peri_interrupt,
        disable_peri_interrupt }) (unstable)), (@ peri_type #[doc =
        ...
        #[doc = "KEYMNG peripheral singleton"] KEYMNG <= KEYMNG(KM : {
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable)), (@ peri_type #[doc = "LEDC peripheral singleton"] LEDC <= LEDC()
        ...
        = "LP_CLKRST peripheral singleton"] LP_CLKRST <= LP_CLKRST() (unstable)), (@
        peri_type #[doc = "LP_GPIO peripheral singleton"] LP_GPIO <= LP_GPIO()
        ...
        = "LP_WDT peripheral singleton"] LP_WDT <= LP_WDT() (unstable)), (@ peri_type
        #[doc = "MCPWM0 peripheral singleton"] MCPWM0 <= MCPWM0(MCPWM0 : {
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable)), (@ peri_type #[doc = "MCPWM1 peripheral singleton"] MCPWM1 <=
        MCPWM1(MCPWM1 : { bind_peri_interrupt, enable_peri_interrupt,
        disable_peri_interrupt }) (unstable)), (@ peri_type #[doc =
        ...
        TOUCH(TOUCH : { bind_peri_interrupt, enable_peri_interrupt,
        disable_peri_interrupt }) (unstable)), (@ peri_type #[doc =
        "TOUCH_AON peripheral singleton"] TOUCH_AON <= TOUCH_AON() (unstable)), (@
        peri_type #[doc = "TWAI0 peripheral singleton"] TWAI0 <= TWAI0(TWAI0 : {
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt }, TWAI0_TIMER
        ...
        USB0(USB_OTG11 : { bind_peri_interrupt, enable_peri_interrupt,
        disable_peri_interrupt }) (unstable)), (@ peri_type #[doc =
        ...
        (GPIO37), (GPIO38), (GPIO39), (DMA_CH0(unstable)), (DMA_CH1(unstable)),
        (DMA_CH2(unstable)), (DMA_CH3(unstable)), (DMA_CH4(unstable)), (AES(unstable)),
        (APB_SARADC(unstable)), (ASRC(unstable)), (BUS_MONITOR(unstable)),
        (CACHE(unstable)), (CLIC(unstable)), (CLINT(unstable)),
        (CLINT_OTHER_CORE(unstable)), (CPU_APM(unstable)), (DMA(unstable)),
        (ECC(unstable)), (ECDSA(unstable)), (ETM(unstable)), (GPIO(unstable)),
        (GPIO_DEDICATED(unstable)), (GPIO_SD(unstable)), (HMAC(unstable)),
        ...
        (KEYMNG(unstable)), (LEDC(unstable)), (LPWR(unstable)), (LP_ANA(unstable)),
        (LP_AON(unstable)), (LP_CLKRST(unstable)), (LP_GPIO(unstable)),
        (LP_IO_MUX(unstable)), (LP_PERI(unstable)), (LP_TEE(unstable)),
        (LP_WDT(unstable)), (MCPWM0(unstable)), (MCPWM1(unstable)),
        (MEM_MONITOR(unstable)), (MODEM_LPCON(unstable)), (MODEM_SYSCON(unstable)),
        (PARL_IO(unstable)), (PAU(unstable)), (PCNT(unstable)), (PCR(unstable)),
        (PMU(unstable)), (PVT(unstable)), (RMT(unstable)), (RNG(unstable)),
        (SHA(unstable)), (RTC_TIMER(unstable)), (SPI0(unstable)), (SPI1(unstable)),
        (SPI2), (SPI3), (SYSTEM(unstable)), (SYSTIMER(unstable)), (TEE(unstable)),
        (TIMG0(unstable)), (TIMG1(unstable)), (TOUCH(unstable)), (TOUCH_AON(unstable)),
        (TWAI0(unstable)), (UART0), (UART1), (UHCI0(unstable)), (USB_DEVICE(unstable)),
        (USB_FS(unstable)), (ZERO_DET(unstable)), (ADC1(unstable)), (CPU_CTRL(unstable)),
        (IPC(unstable)), (FLASH(unstable)), (FROM_CPU_INTR0(unstable)),
        (FROM_CPU_INTR1(unstable)), (FROM_CPU_INTR2(unstable)),
        (FROM_CPU_INTR3(unstable)))); _for_each_inner_peripheral!((dma_eligible(SPI3,
        Spi3, 0, AhbGdmaChannel), (SPI2, Spi2, 1, AhbGdmaChannel), (UHCI0, Uhci0, 2,
        AhbGdmaChannel), (I2S0, I2s0, 3, AhbGdmaChannel), (AES, Aes, 4, AhbGdmaChannel),
        (SHA, Sha, 7, AhbGdmaChannel), (PARL_IO, ParlIo, 9, AhbGdmaChannel)));
    };
}
...
macro_rules! for_each_analog_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        tt) => {} } _for_each_inner_analog_function!((ZCD0, GPIO0));
        _for_each_inner_analog_function!((ZCD1, GPIO1));
        _for_each_inner_analog_function!((ZCD2, GPIO2));
        _for_each_inner_analog_function!((ZCD3, GPIO3));
        _for_each_inner_analog_function!((XTAL_32K_N, GPIO4));
        ...
        _for_each_inner_analog_function!((USB_FS_DM, GPIO21));
        _for_each_inner_analog_function!((USB_FS_DP, GPIO22));
        ...
        _for_each_inner_analog_function!(((ZCD0, ZCDn, 0), GPIO0));
        _for_each_inner_analog_function!(((ZCD1, ZCDn, 1), GPIO1));
        _for_each_inner_analog_function!(((ZCD2, ZCDn, 2), GPIO2));
        _for_each_inner_analog_function!(((ZCD3, ZCDn, 3), GPIO3));
        ...
        _for_each_inner_analog_function!((all(ZCD0, GPIO0), (ZCD1, GPIO1), (ZCD2, GPIO2),
        (ZCD3, GPIO3), (XTAL_32K_N, GPIO4), (XTAL_32K_P, GPIO5), (USJ_DM, GPIO13),
        (USJ_DP, GPIO14), (USB_FS_DM, GPIO21), (USB_FS_DP, GPIO22), (ADC1_CH0, GPIO28),
        (ADC1_CH1, GPIO29), (ADC1_CH2, GPIO30), (ADC1_CH3, GPIO31), (ADC1_CH4, GPIO32)));
        _for_each_inner_analog_function!((ZCDn((ZCD0, ZCDn, 0), GPIO0), ((ZCD1, ZCDn, 1),
        GPIO1), ((ZCD2, ZCDn, 2), GPIO2), ((ZCD3, ZCDn, 3), GPIO3)));
...
macro_rules! gpio_for_signal {
    ...
    (ZCD2 $(, $_fallback:literal)?) => {
        "GPIO2"
    };
    (ZCD3 $(, $_fallback:literal)?) => {
        "GPIO3"
    };
