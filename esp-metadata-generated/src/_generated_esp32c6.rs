...
macro_rules! property {
    ...
    ("clock_tree.i2s.tx_clk.sclk") => {
        ...
        ::soc::clocks::I2sClkSclk::PllF240m, crate ::soc::clocks::I2sClkSclk::PllF160m]
    };
        ...
        impl I2sInstance {
            pub fn configure_tx_clk(self, clocks: &mut ClockTree, config: I2sClkConfig) {
                ...
                if clocks.i2s_tx_clk_refcount[self as usize] > 0 {
                    match config.sclk {
                        ...
                        I2sClkSclk::PllF240m => request_pll_f240m(clocks),
                        I2sClkSclk::PllF160m => request_pll_f160m(clocks),
                    }
                    self.configure_tx_clk_impl(clocks, old_config, config);
                    if let Some(old_config) = old_config {
                        match old_config.sclk {
                            I2sClkSclk::Xtal => release_xtal_clk(clocks),
                            I2sClkSclk::PllF240m => release_pll_f240m(clocks),
                            I2sClkSclk::PllF160m => release_pll_f160m(clocks),
                        }
                    }
                } else {
                    self.configure_tx_clk_impl(clocks, old_config, config);
            ...
            pub fn tx_clk_config_frequency(clocks: &mut ClockTree, config: I2sClkConfig) -> u32 {
                (((match config.sclk {
                    ...
                    I2sClkSclk::PllF240m => pll_f240m_frequency(),
                    I2sClkSclk::PllF160m => pll_f160m_frequency(),
                } as u64)
                    * (config.div_a() as u64))
        ...
        impl SpiInstance {
            pub fn configure_function_clock(
                ...
                if clocks.spi_function_clock_refcount[self as usize] > 0 {
                    match new_selector {
                        SpiFunctionClockConfig::PllF80m => request_pll_f80m(clocks),
                    ...
                    if let Some(old_selector) = old_selector {
                        match old_selector {
                            SpiFunctionClockConfig::PllF80m => release_pll_f80m(clocks),
...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_peripheral!((@ peri_type #[doc = "LP_UART peripheral singleton"]
        LP_UART <= LP_UART() (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc
        ...
        <= LP_PERI() (unstable))); _for_each_inner_peripheral!((@ peri_type #[doc =
        ...
        "TWAI1 peripheral singleton"] TWAI1 <= TWAI1() (unstable)));
        ...
        #[doc = "TWAI1 peripheral singleton"] TWAI1 <= TWAI1() (unstable)), (@ peri_type
        ...
        #[doc = "TSENS peripheral singleton"] TSENS <= virtual() (unstable)), (@
        ...
        (PCNT0_UNIT0(unstable)), (PCNT0_UNIT1(unstable)), (PCNT0_UNIT2(unstable)),
        (PCNT0_UNIT3(unstable)), (SDM_CH0(unstable)), (SDM_CH1(unstable)),
        (SDM_CH2(unstable)), (SDM_CH3(unstable)), (AES(unstable)),
...
macro_rules! for_each_lp_function {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_lp_function!((LP_UART_DTRN, GPIO0, _1));
        _for_each_inner_lp_function!((LP_GPIO1, GPIO1, _0));
        _for_each_inner_lp_function!((LP_UART_DSRN, GPIO1, _1));
        _for_each_inner_lp_function!((LP_GPIO2, GPIO2, _0));
        _for_each_inner_lp_function!((LP_UART_RTSN, GPIO2, _1));
        _for_each_inner_lp_function!((LP_GPIO3, GPIO3, _0));
        _for_each_inner_lp_function!((LP_UART_CTSN, GPIO3, _1));
        _for_each_inner_lp_function!((LP_GPIO4, GPIO4, _0));
        _for_each_inner_lp_function!((LP_UART_RXD, GPIO4, _1));
        _for_each_inner_lp_function!((LP_GPIO5, GPIO5, _0));
        _for_each_inner_lp_function!((LP_UART_TXD, GPIO5, _1));
        _for_each_inner_lp_function!((LP_GPIO6, GPIO6, _0));
        _for_each_inner_lp_function!((LP_I2C_SDA, GPIO6, _1));
        _for_each_inner_lp_function!((LP_GPIO7, GPIO7, _0));
        _for_each_inner_lp_function!((LP_I2C_SCL, GPIO7, _1));
        ...
        _for_each_inner_lp_function!((all(LP_GPIO0, GPIO0, _0), (LP_UART_DTRN, GPIO0,
        _1), (LP_GPIO1, GPIO1, _0), (LP_UART_DSRN, GPIO1, _1), (LP_GPIO2, GPIO2, _0),
        (LP_UART_RTSN, GPIO2, _1), (LP_GPIO3, GPIO3, _0), (LP_UART_CTSN, GPIO3, _1),
        (LP_GPIO4, GPIO4, _0), (LP_UART_RXD, GPIO4, _1), (LP_GPIO5, GPIO5, _0),
        (LP_UART_TXD, GPIO5, _1), (LP_GPIO6, GPIO6, _0), (LP_I2C_SDA, GPIO6, _1),
        (LP_GPIO7, GPIO7, _0), (LP_I2C_SCL, GPIO7, _1)));
