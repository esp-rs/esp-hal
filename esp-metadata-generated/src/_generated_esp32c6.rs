...
macro_rules! for_each_peripheral {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        SLCHOST() (unstable))); _for_each_inner!((ETM <= SOC_ETM() (unstable)));
        ...
        bind_peri_interrupt, enable_peri_interrupt, disable_peri_interrupt })
        (unstable)), (SLC <= SLC() (unstable)), (SLCHOST <= SLCHOST() (unstable)), (ETM
        <= SOC_ETM() (unstable)), (SPI0 <= SPI0() (unstable)), (SPI1 <= SPI1()
        (unstable)), (SPI2 <= SPI2(SPI2 : { bind_peri_interrupt, enable_peri_interrupt,
        ...
        virtual() (unstable)), (BT <= virtual() (unstable)), (LP_CORE <= virtual()
        (unstable)), (SW_INTERRUPT <= virtual() (unstable)), (TSENS <= virtual()
        (unstable)), (WIFI <= virtual() (unstable)), (MEM2MEM1 <= virtual() (unstable)),
        (MEM2MEM4 <= virtual() (unstable)), (MEM2MEM5 <= virtual() (unstable)),
        (MEM2MEM10 <= virtual() (unstable)), (MEM2MEM11 <= virtual() (unstable)),
        (MEM2MEM12 <= virtual() (unstable)), (MEM2MEM13 <= virtual() (unstable)),
        (MEM2MEM14 <= virtual() (unstable)), (MEM2MEM15 <= virtual() (unstable))));
    };
}
