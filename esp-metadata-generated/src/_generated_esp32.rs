...
macro_rules! for_each_gpio {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        (_1 => VSPICS0 _3 => HS1_DATA6) ([Input] [Output])), (12, GPIO12(_0 => MTDI _1 =>
        HSPIQ _3 => HS2_DATA2 _4 => SD_DATA2) (_1 => HSPIQ _3 => HS2_DATA2 _4 => SD_DATA2
        _5 => EMAC_TXD3) ([Input] [Output])), (13, GPIO13(_0 => MTCK _1 => HSPID _3 =>
        HS2_DATA3 _4 => SD_DATA3 _5 => EMAC_RX_ER) (_1 => HSPID _3 => HS2_DATA3 _4 =>
        ...
        GPIO36() () ([Input] [])), (37, GPIO37() () ([Input] [])), (38, GPIO38() ()
        ([Input] [])), (39, GPIO39() () ([Input] []))));
    };
}
