...
macro_rules! for_each_gpio {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        HS2_DATA0 _4 => SDIO_DATA0) (Input Output Analog RtcIo RtcIoOutput Touch)));
        _for_each_inner!((3, GPIO3(_0 => U0RXD) (_1 => CLK_OUT2) (Input Output)));
        _for_each_inner!((4, GPIO4(_1 => HSPIHD _3 => HS2_DATA1 _4 => SDIO_DATA1 _5 =>
        EMAC_TX_ER) (_1 => HSPIHD _3 => HS2_DATA1 _4 => SDIO_DATA1 _5 => EMAC_TX_ER)
        (Input Output Analog RtcIo RtcIoOutput Touch))); _for_each_inner!((5, GPIO5(_1 =>
        ...
        _3 => HS1_DATA1) (Input Output))); _for_each_inner!((9, GPIO9(_0 => SDIO_DATA2 _1
        => SPIHD _3 => HS1_DATA2 _4 => U1RXD) (_0 => SDIO_DATA2 _1 => SPIHD _3 =>
        HS1_DATA2) (Input Output))); _for_each_inner!((10, GPIO10(_0 => SDIO_DATA3 _1 =>
        SPIWP _3 => HS1_DATA3) (_0 => SDIO_DATA3 _1 => SPIWP _3 => HS1_DATA3 _4 => U1TXD)
        (Input Output))); _for_each_inner!((11, GPIO11(_0 => SDIO_CMD _1 => SPICS0) (_0
        => SDIO_CMD _1 => SPICS0 _3 => HS1_CMD _4 => U1RTS) (Input Output)));
        _for_each_inner!((12, GPIO12(_0 => MTDI _1 => HSPIQ _3 => HS2_DATA2 _4 =>
        SDIO_DATA2) (_1 => HSPIQ _3 => HS2_DATA2 _4 => SDIO_DATA2 _5 => EMAC_TXD3) (Input
        Output Analog RtcIo RtcIoOutput Touch))); _for_each_inner!((13, GPIO13(_0 => MTCK
        _1 => HSPID _3 => HS2_DATA3 _4 => SDIO_DATA3 _5 => EMAC_RX_ER) (_1 => HSPID _3 =>
        HS2_DATA3 _4 => SDIO_DATA3 _5 => EMAC_RX_ER) (Input Output Analog RtcIo
        RtcIoOutput Touch))); _for_each_inner!((14, GPIO14(_0 => MTMS _1 => HSPICLK) (_1
        => HSPICLK _3 => HS2_CLK _4 => SDIO_CLK _5 => EMAC_TXD2) (Input Output Analog
        RtcIo RtcIoOutput Touch))); _for_each_inner!((15, GPIO15(_1 => HSPICS0 _4 =>
        SDIO_CMD _5 => EMAC_RXD3) (_0 => MTDO _1 => HSPICS0 _3 => HS2_CMD _4 => SDIO_CMD)
        (Input Output Analog RtcIo RtcIoOutput Touch))); _for_each_inner!((16, GPIO16(_3
        ...
        EMAC_TX_ER) (Input Output Analog RtcIo RtcIoOutput Touch)), (5, GPIO5(_1 =>
        VSPICS0 _3 => HS1_DATA6 _5 => EMAC_RX_CLK) (_1 => VSPICS0 _3 => HS1_DATA6) (Input
        Output)), (6, GPIO6(_1 => SPICLK _4 => U1CTS) (_0 => SDIO_CLK _1 => SPICLK _3 =>
        HS1_CLK) (Input Output)), (7, GPIO7(_0 => SDIO_DATA0 _1 => SPIQ _3 => HS1_DATA0)
        (_0 => SDIO_DATA0 _1 => SPIQ _3 => HS1_DATA0 _4 => U2RTS) (Input Output)), (8,
        ...
        (Input Output)), (10, GPIO10(_0 => SDIO_DATA3 _1 => SPIWP _3 => HS1_DATA3) (_0 =>
        SDIO_DATA3 _1 => SPIWP _3 => HS1_DATA3 _4 => U1TXD) (Input Output)), (11,
        GPIO11(_0 => SDIO_CMD _1 => SPICS0) (_0 => SDIO_CMD _1 => SPICS0 _3 => HS1_CMD _4
        => U1RTS) (Input Output)), (12, GPIO12(_0 => MTDI _1 => HSPIQ _3 => HS2_DATA2 _4
        => SDIO_DATA2) (_1 => HSPIQ _3 => HS2_DATA2 _4 => SDIO_DATA2 _5 => EMAC_TXD3)
        (Input Output Analog RtcIo RtcIoOutput Touch)), (13, GPIO13(_0 => MTCK _1 =>
        HSPID _3 => HS2_DATA3 _4 => SDIO_DATA3 _5 => EMAC_RX_ER) (_1 => HSPID _3 =>
        HS2_DATA3 _4 => SDIO_DATA3 _5 => EMAC_RX_ER) (Input Output Analog RtcIo
        RtcIoOutput Touch)), (14, GPIO14(_0 => MTMS _1 => HSPICLK) (_1 => HSPICLK _3 =>
        HS2_CLK _4 => SDIO_CLK _5 => EMAC_TXD2) (Input Output Analog RtcIo RtcIoOutput
        Touch)), (15, GPIO15(_1 => HSPICS0 _4 => SDIO_CMD _5 => EMAC_RXD3) (_0 => MTDO _1
        => HSPICS0 _3 => HS2_CMD _4 => SDIO_CMD) (Input Output Analog RtcIo RtcIoOutput
        Touch)), (16, GPIO16(_3 => HS1_DATA4 _4 => U2RXD) (_3 => HS1_DATA4 _5 =>
        EMAC_CLK_OUT) (Input Output)), (17, GPIO17(_3 => HS1_DATA5) (_3 => HS1_DATA5 _4
        => U2TXD _5 => EMAC_CLK_180) (Input Output)), (18, GPIO18(_1 => VSPICLK _3 =>
        HS1_DATA7) (_1 => VSPICLK _3 => HS1_DATA7) (Input Output)), (19, GPIO19(_1 =>
        VSPIQ _3 => U0CTS) (_1 => VSPIQ _5 => EMAC_TXD0) (Input Output)), (20, GPIO20()
