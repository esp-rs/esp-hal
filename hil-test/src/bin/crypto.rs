...
//% CHIP_FILTER(psram):    (aes_driver_supported || ecc_driver_supported || rsa_driver_supported) && dma_can_access_psram
//% CHIP_FILTER(no_psram): (aes_driver_supported || ecc_driver_supported || rsa_driver_supported) && !dma_can_access_psram
