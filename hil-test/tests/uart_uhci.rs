...
const MEDIUM_TEST_STRING: &str = "Loremipsumdolorsitamet,consecteturadipiscingelit.Suspendissemetusnisl,pretiumsedeuismodeget,bibendumeusem.Donecaccumsanrisusnibh";
const SHORT_TEST_STRING: &str = "Hello ESP32";
const DMA_BUFFER_SIZE: u16 = 4092;
const LOOP_COUNT: u32 = 5;
const BAUDRATE: u32 = 921600;
const BAUDRATES: &[u32] = &[576000, 921600];
// 9600, 19200, 28800, 38400, 57600, 76800, 115200, 230400, 460800,
