...
A good chunk of the code is generated from metadata. The metadata lives in `esp-metadata`. The code in `esp-metadata-generated` is generated by the `xtask`, using the `cargo xtask update-metadata` command, and using the `esp-metadata` crate as a library.
