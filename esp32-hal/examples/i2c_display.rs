...
use esp32_hal::{gpio::IO, i2c, pac::Peripherals, prelude::*, Serial, Timer, I2C};
use nb::block;
use panic_halt as _;
...
fn main() -> ! {
    ...
    // Enable peripheral manually for now
    peripherals
        .DPORT
        .perip_clk_en
        .modify(|_, w| w.i2c0().set_bit());
    peripherals
        .DPORT
        .perip_rst_en
        .modify(|_, w| w.i2c0().clear_bit());
