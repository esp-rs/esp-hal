...
//!   sleeps only while the controller sleeps, and only on the ESP32-C3, ESP32-C6 and ESP32-S3. On
//!   the other chips, BLE keeps the chip awake. The ESP32 can sleep only with a 32 kHz crystal as
//!   the BLE low-power clock.
//!
...
/// [`MODEM_SLEEP`] to be enabled. The chip sleeps only on the ESP32-C3, ESP32-C6 and ESP32-S3.
