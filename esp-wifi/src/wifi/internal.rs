...
static mut G_COEX_ADAPTER_FUNCS: crate::binary::include::coex_adapter_funcs_t =
...
unsafe extern "C" fn semphr_take_from_isr_wrapper(
    semphr: *mut esp_wifi_sys::c_types::c_void,
    hptw: *mut esp_wifi_sys::c_types::c_void,
) -> i32 {
...
pub(crate) const WIFI_FEATURE_CAPS: u64 = WIFI_ENABLE_WPA3_SAE | WIFI_ENABLE_ENTERPRISE;

#[no_mangle]
pub(crate) static mut g_wifi_feature_caps: u64 = WIFI_FEATURE_CAPS;
